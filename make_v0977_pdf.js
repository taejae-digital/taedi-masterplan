...
(async () => {
  ...
  const targetUrl = process.env.MP_URL || 'http://localhost:3099/mp/v0.9.77';
  await page.goto(targetUrl, { waitUntil: 'domcontentloaded', timeout: 60000 });
  await new Promise(r => setTimeout(r, 12000));

  const outPath = '/Users/taejae-agent/workspace/taedi-masterplan/pdf/masterplan-v0.9.77.pdf';
