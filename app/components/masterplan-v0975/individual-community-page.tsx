      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            산업화는 인간의 근육을 대체해 분업 시대를 만들었다. 디지털·AI는 두뇌를 대체·보완하며 새로운 인재상을 요구한다.
          </div>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, marginBottom: 6 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                ...
                <th style={{ padding: "4px 6px", textAlign: "left", width: "16%" }}>이상적 인재상</th>
              ...
              {[
                {
                  age: "농업",
                  highlight: false,
                  task: "위계 정당화·지식 전승·식량 생산",
                  tech: "종교 의례·문자·관개술",
                  expert: "통치 권위·경험 전승·생산의 기예",
                ...
                },
                {
                  age: "산업",
                  highlight: false,
                  task: "대규모 조직 운영·분과 전문화·대량 생산",
                  tech: "관료제·조립라인·철도·동력기관",
                  expert: "생산 시스템 설계·분과 전문성·반복 숙련",
                ...
                },
                {
                  age: "디지털",
                  highlight: true,
                  task: "AI 거버넌스·디지털 시스템 구축·AI 활용 생산",
                  tech: "AI·플랫폼 인프라·소프트웨어·생성 AI",
                  expert: "목적 설계·기술-창의 결합·AI 협업",
                  ideal: "T자형 인간 / 조율자(orchestrator)",
                  freedom: "정체성 실현의 자유 — 잘하고, 좋아하고, 사회가 필요로 하는 일을 하는 자유",
                },
              ].map(({ age, highlight, task, tech, expert, ideal, freedom }, i) => (
                <tr key={i} style={{ background: highlight ? "#f0f4ff" : i % 2 ? C.bg : "#fff" }}>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid ${highlight ? C.navy : "#eee"}`, fontWeight: 800, color: highlight ? C.navy : "#333", lineHeight: 1.45, verticalAlign: "top", fontSize: 13 }}>{age}</td>
                  <td style={{ padding: "5px 6px", borderBottom: "1px solid #eee", color: "#222", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500 }}>{task}</td>
                  <td style={{ padding: "5px 6px", borderBottom: "1px solid #eee", color: "#333", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500 }}>{tech}</td>
                  <td style={{ padding: "5px 6px", borderBottom: "1px solid #eee", color: "#222", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500 }}>{expert}</td>
                  <td style={{ padding: "5px 6px", borderBottom: "1px solid #eee", color: highlight ? C.navy : "#222", fontWeight: highlight ? 800 : 600, lineHeight: 1.45, verticalAlign: "top" }}>{ideal}</td>
                  <td style={{ padding: "5px 6px", borderBottom: "1px solid #eee", color: highlight ? C.red : "#333", lineHeight: 1.45, verticalAlign: "top", fontWeight: highlight ? 700 : 500 }}>{freedom}</td>
                </tr>
              ))}
            </tbody>
          </table>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: "#333" }}>
            <strong style={{ color: C.navy }}>인재상이 시대를 만든다 —</strong> 농업시대는 지혜를 전하는 원로가, 산업시대는 분업을 이끄는 전문가가 시대를 정의했다. 디지털 시대는 가로축의 협업력과 세로축의 전문성을 모두 가진 T자형 인간, 곧 <strong>조율자(orchestrator)</strong>가 그 자리를 맡는다.
          </div>
        </div>
