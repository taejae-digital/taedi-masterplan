    ...
    <div style={{ height: "281mm", overflow: "hidden", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        <div>
          ...
          <p style={ps}>
            <strong style={em}>디지털 시대에는 생산 능력이 개인화되고, 협업은 스킬 분업에서 정체성 기반 협업으로 옮겨간다.</strong> AI·데이터·컴퓨팅은 분석·기획·제작·유통·조율의 비용을 낮추고 과거 조직 내부에 묶여 있던 생산 능력을 개인에게 내려준다. 생산 능력이 개인화되면 작고 구체적인 필요도 경제성을 갖는다. 대기업이 보기에는 너무 작았던 수요, 표준 상품으로는 포착되지 않던 니치마켓이 개인 생산자의 시장이 되고, 그 결과 시장과 공동체는 다양화된다. 크리스 앤더슨(前 『와이어드』 편집장)은 <em style={{ fontStyle: "normal", color: C.muted, fontWeight: 600 }}>『롱테일』(2006)에서 생산·유통 비용이 낮아질수록 무수한 틈새 수요가 합쳐져 거대한 시장이 된다고 본다.</em>
          </p>
        </div>
