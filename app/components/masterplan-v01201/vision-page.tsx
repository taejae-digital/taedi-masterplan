...
const flow = [
  ...
  },
  {
    ...
    t: "개인이 바라는 삶이 달라지면 공동체의 역할도 달라진다",
    industrial: "산업화: 학교·회사·국가가 개인을 표준 경로에 배치",
    digital: "디지털: 발견·실험·훈련·발휘를 공동체가 이어 줌",
    c: "#555555", soft: "#ffffff",
  },
  {
    ...
    <div style={{ height: "281mm", overflow: "hidden", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            농업 시대에는 출생부터 노년까지 삶의 대부분을 집안과 마을이 맡았다. 아이는 가족과 이웃의 손에서 자라고, 일은 집안과 마을 안에서 배우며, 노년은 가족의 봉양에 기대었다. 산업화 시대에는 학교·회사·국가가 삶의 경로를 정했다. 아이는 표준 교육을 받고, 청년은 좋은 직장에 들어가고, 노년은 연금과 복지에 기대었다.
          </p>
          <p style={ps}>
            개인의 선택지는 넓어진 것처럼 보였지만, 실제로는 학교·회사·국가가 정해 놓은 길 안에서 움직였다. 디지털 시대에는 개인이 먼저 보여야 한다. 타고난 기질과 강점의 단서를 일찍 발견하고, 관심을 실험하고, 강점을 훈련하고, 정체성을 실제 기여로 발휘할 무대가 필요하다.
          </p>
          <p style={ps}>
            그래서 공동체의 역할도 더 세밀해진다. 가정은 아이의 단서를 가장 먼저 보고, 이웃은 안전한 실험의 기회를 만들고, 마을은 관심을 훈련으로 이어 준다. 도시는 주거·일·의료·학습이 이어지는 생활권이 되고, 국가는 어디에 살든 최소 권리선과 위험 규칙을 보장해야 한다. 공동체는 개인을 정해진 길에 넣는 틀이 아니라, 그 사람이 발견되고 훈련되고 발휘되도록 이어주는 기반이 되어야 한다.
          </p>
        </div>
