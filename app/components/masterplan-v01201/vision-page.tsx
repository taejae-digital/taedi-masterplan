    ...
    <div style={{ height: "281mm", overflow: "hidden", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            개인의 선택지는 넓어진 것처럼 보였지만, 실제로는 학교·회사·국가가 정해 놓은 길 안에서 움직였다. 디지털 시대에는 개인이 먼저 보여야 한다. 타고난 기질과 강점의 단서를 일찍 발견하고, 관심을 실험하고, 강점을 훈련하고, 정체성을 실제 기여로 발휘할 무대가 필요하다. 공동체는 개인을 정해진 길에 넣는 틀이 아니라, 그 사람이 발견되고 훈련되고 발휘되도록 이어주는 기반이 되어야 한다.
          </p>
        </div>
