    ...
    <div style={{ height: "281mm", overflow: "hidden", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            산업화 사회는 이 필요를 표준 학교·표준 직장·표준 복지로 묶어 처리했다. 디지털 시대에는 반대로 개인의 기질·강점·관심·건강·관계가 더 일찍 발견되고, 생애 단계마다 필요한 공동체가 달라진다. 따라서 공동체는 기능을 결합하는 장치가 아니라 <strong style={em}>개인의 생애 필요를 발견·실험·훈련·발휘·보장으로 이어주는 역할 체계</strong>가 된다. 이것이 사회를 구성하는 근본 원리다.
          </p>
        </div>
