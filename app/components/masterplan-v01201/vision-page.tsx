    ...
    <div style={{ height: "281mm", overflow: "hidden", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            선택지는 넓어진 것처럼 보였지만, 실제로는 학교·회사·국가가 정해 놓은 길 안에서 움직였다. 표준은 곧 <span style={{ color: C.teal, fontWeight: 900 }}>줄세우기</span>였다. 디지털 시대의 핵심은 <span style={{ color: C.teal, fontWeight: 900 }}>정체성</span>이다. 개인마다 다른 기질·강점·관심이 먼저 보이고, 그 <span style={{ color: C.teal, fontWeight: 900 }}>다양성</span>이 낭비되지 않아야 한다. 타고난 단서를 일찍 발견하고, 관심을 실험하고, 강점을 훈련하고, 정체성을 실제 기여로 발휘할 무대가 필요하다.
          </p>
          <p style={ps}>
            그래서 공동체의 역할도 더 세밀해질 것이다. 가정은 아이의 단서를 가장 먼저 보고, 이웃은 안전한 실험의 기회를 만들고, 마을은 관심을 훈련으로 이어 준다. 도시는 주거·일·의료·학습이 이어지는 생활권이 되고, 국가는 어디에 살든 최소 권리선과 위험 규칙을 보장해야 한다. 공동체는 개인을 정해진 길에 넣는 틀이 아니라, 그 사람이 <span style={{ color: C.teal, fontWeight: 900 }}>발견</span>되고 <span style={{ color: C.teal, fontWeight: 900 }}>훈련</span>되고 <span style={{ color: C.teal, fontWeight: 900 }}>발휘</span>되도록 이어주는 기반이 되어야 한다.
          </p>
        </div>
