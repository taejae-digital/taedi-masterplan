...
export const lifeStages: LifeStage[] = [
  {
    ...
    digTags: ["가정", "국가"],
    ind: {
      lead: "좋은 양육 환경에서 자질을 일찍 알아봐 주고, 가정이 가능성을 키울 여건을 누린다.",
      pro: "또래 평균 발달표에 맞춰 길러진다.",
      ama: "돌봄 공백으로 발달 지연이 늦게 발견된다.",
  ...
  },
  {
    ...
    digTags: ["가정", "이웃", "마을"],
    ind: {
      lead: "풍부한 자원 속에서 두각을 드러내고, 잘하는 분야로 빠르게 앞서 나간다.",
      pro: "표준 교육과정을 성적 위주로 따라간다.",
      ama: "교육 자원이 부족해 흥미 펼칠 통로가 막힌다.",
      margin: "기초 보육·교육에서 이탈해 출발선에 못 선다.",
    },
    digitalPerson: {
  ...
  },
  {
    ...
    digTags: ["마을", "도시"],
    ind: {
      lead: "탁월한 실력으로 인정받으며, 원하는 진로를 골라 자기 강점을 밀어붙인다.",
      pro: "점수로 진로가 정해져 강점을 묻지 못한다.",
      ama: "성적에 밀려 다른 재능은 훈련받지 못한다.",
      margin: "진학에서 탈락하면 길이 막혀 낙오한다.",
    },
    digitalPerson: {
  ...
  },
  {
    ...
    digTags: ["도시", "세계"],
    ind: {
      lead: "자본·조직·기회를 쥐고 시장과 생산을 주도하며, 자기 역량을 마음껏 발휘한다.",
      pro: "조직이 정한 직무에 강점을 맞춘다.",
      ama: "불안정 고용으로 펼칠 무대를 얻지 못한다.",
  ...
  },
  {
    ...
    digTags: ["가정", "도시", "국가"],
    ind: {
      lead: "조직의 핵심 위치에서 영향력을 키우며, 쌓은 역량으로 더 큰 결정을 이끈다.",
      pro: "재학습 없이 기술 변화 앞에서 버틴다.",
      ama: "고용 불안으로 경력 중단 위험을 안는다.",
  ...
  },
  {
    ...
    digTags: ["가정", "이웃", "마을"],
    ind: {
      lead: "자산·지위를 갖춘 원로로서 영향력을 유지하고, 평생의 권위를 발휘한다.",
      pro: "은퇴와 함께 '부양 대상'으로 남는다.",
      ama: "노후 준비 부족으로 생계·건강을 걱정한다.",
...
export type CommunityShift = {
  ...
  digFacility: string;
  digOrg: string;
  // 디지털: 이 공동체가 맡는 생애단계 / 산업화: 이 공동체가 떠맡거나 빠진 단계
  answers: string;
  indAnswers: string;
};
...
export const communityShift: CommunityShift[] = [
  {
    ...
    indAnswers: "태아·아동 양육과 노년 부양만 가정에 집중",
  },
  {
    unit: "이웃",
    indRole: "표준 제도에 가려 잘 안 쓰인 관계망",
    ...
    indAnswers: "유아·아동의 관계·돌봄을 맡지 못하고 비어 있음",
  },
  {
    unit: "마을",
    ...
    indAnswers: "청소년 훈련을 맡지 못하고 도시 입시에 넘김",
  },
  {
    unit: "도시",
  ...
  },
  {
    ...
    indAnswers: "전 단계를 표준 제도로 일괄 관리, 단계 구분 없음",
  },
  {
    unit: "세계",
    ...
    digRole: "국경 넘는 위험을 함께 관리하는 공동 질서",
    digFacility: "공동위험 관리 · 협력 규칙",
    digOrg: "WMD·기후·AI·감염병 공동관리 · 글로벌 협업 규칙",
    answers: "국경 넘는 위험에서 모든 단계의 안전 보장",
