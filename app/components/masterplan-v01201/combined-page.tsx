...
const polTransitionRows: PolTransitionRow[] = [
  {
    ...
    change: "개인 에이전트가 정체성·생애 요구·이해관계를 지속 표현",
    newOrder: "표현의 대리 정확성과 공정성 보장",
  },
  {
    label: "공동체 연결",
    industrial: "학교·회사·복지 제도에 개인을 배치",
    change: "생애 요구가 가정·이웃·마을·도시·국가·세계 기능으로 분화",
    newOrder: "개인 요구와 공동체 역할 연결",
  },
  {
    label: "접근 보장",
    industrial: "표준 교육·고용·복지를 평균 기준으로 제공",
    change: "공동체 기능 접근 격차가 새 불평등이 됨",
    newOrder: "필요한 공동체 기능에 대한 접근 보장",
  },
  {
    label: "역할 조정",
    industrial: "중앙정부가 법·예산·제도로 일괄 조정",
    change: "공동체 간 기능 중복·공백·충돌 발생",
    newOrder: "역할 배분과 책임 공백 조정",
  },
  {
    label: "균형 형성",
    industrial: "다수결·대표성·절차적 합법성 중심",
    change: "다양한 정체성과 이해관계가 첨예하게 충돌",
