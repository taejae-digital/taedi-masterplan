  ...
  const lifeStages = [
    {
      ...
      indTags: ["가정", "국가"],
      digTags: ["가정", "국가"],
      industrialPerson: { trait: "가정 환경이 출발선을 정한다", lead: "양육·의료 자원이 풍부한 가정", pro: "기본 돌봄이 안정된 가정", ama: "돌봄 공백이 잦은 가정", margin: "의료·보호에서 소외된 가정" },
      digitalPerson: { trait: "모든 가능성을 지니고 태어난다", lead: "정체성 단서가 일찍 풍부하게 읽힘", pro: "단서가 비교적 선명하게 읽힘", ama: "단서가 단편적으로 읽힘", margin: "데이터·관찰이 닿지 않음" },
    ...
    },
    {
      ...
      indTags: ["가정", "도시"],
      digTags: ["가정", "이웃"],
      industrialPerson: { trait: "조기교육·사교육이 격차를 만든다", lead: "사교육·선행학습을 풍부히 받음", pro: "표준 교육을 충실히 따라감", ama: "교육 자원이 부족함", margin: "기초 보육·교육에서 이탈" },
      digitalPerson: { trait: "다양한 체험으로 단서를 확인한다", lead: "폭넓은 체험으로 강점이 또렷해짐", pro: "관심 분야를 꾸준히 탐색함", ama: "체험 기회가 제한적임", margin: "발견을 도울 환경이 없음" },
    ...
    },
    {
      ...
      indTags: ["도시"],
      digTags: ["마을", "도시"],
      industrialPerson: { trait: "입시 성적이 진로를 가른다", lead: "상위권 성적으로 명문대 진학", pro: "중상위권으로 대학 진학", ama: "성적 경쟁에서 밀려남", margin: "진학 경로에서 탈락" },
      digitalPerson: { trait: "기여 큰 정체성을 골라 훈련한다", lead: "강점을 집중 훈련해 두각", pro: "방향을 정해 꾸준히 단련", ama: "훈련 기회가 제한적임", margin: "훈련 경로에 닿지 못함" },
    ...
    },
    {
      ...
      indTags: ["도시"],
      digTags: ["도시"],
      industrialPerson: { trait: "학벌·취업이 위치를 정한다", lead: "명문대·대기업 진입", pro: "정규직으로 노동시장 진입", ama: "불안정 고용에 머묾", margin: "취업시장에서 배제" },
      digitalPerson: { trait: "정체성을 실제 기여로 발휘한다", lead: "창업·전문직으로 영향력 발휘", pro: "전문 영역에서 기여 정착", ama: "기여 기회가 산발적임", margin: "발휘 무대에 서지 못함" },
    ...
    },
    {
      ...
      indTags: ["도시", "국가"],
      digTags: ["가정", "도시", "국가"],
      industrialPerson: { trait: "직위·고용 안정성이 갈린다", lead: "관리직·고소득으로 안정", pro: "고용을 유지하며 경력 축적", ama: "고용 불안에 노출", margin: "실직·경력 단절" },
      digitalPerson: { trait: "정체성을 재설계·확장한다", lead: "경험·데이터로 영향력 확장", pro: "기여 방식을 갱신·심화", ama: "재학습 기회가 부족함", margin: "전환 지원에서 소외" },
    ...
    },
    {
      ...
      indTags: ["국가"],
      digTags: ["가정", "이웃", "마을"],
      industrialPerson: { trait: "은퇴 후 자산·건강이 좌우한다", lead: "자산·건강으로 여유로운 노년", pro: "연금으로 생활을 유지", ama: "노후 준비가 부족함", margin: "빈곤·고립에 방치" },
      digitalPerson: { trait: "정체성을 전수·연결한다", lead: "멘토·자문으로 세대를 잇는다", pro: "경험을 후속 세대에 전한다", ama: "전수 기회가 제한적임", margin: "역할 없이 단절됨" },
