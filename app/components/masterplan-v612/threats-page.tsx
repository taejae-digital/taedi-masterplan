      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, flex: 1 }}>
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, marginBottom: 8 }}>
            ...
            <tbody>
              {[
                { dim: "판단력", desc: "AI가 판단·추론·전문성을 개인에게 이전", plus: "의료·법률·재무 접근 민주화, 전문 서비스 비용 하락", minus: "생물·사이버·자율무기 설계, 전문 지식의 치명적 오용" },
                { dim: "생산성", desc: "한 사람이 과거 부서 하나의 산출에 도달", plus: "1인 기업·SaaS, 소규모 혁신 가속", minus: "프로 계층 붕괴, 자동화 실업, 정체성 공백" },
                { dim: "범위", desc: "한 사람이 여러 분야를 동시에 운용", plus: "글로벌 협력, 분야 간 혁신", minus: "미중 기술 패권 블록화, 글로벌 조율 불가" },
                { dim: "접근성", desc: "진입장벽 하락 — 학위·자격증 없이도", plus: "지식 평등, 글로벌 사우스 도약", minus: "허위정보·딥페이크 보편화, 빅테크 봉건제" },
                { dim: "영향력", desc: "도달 범위 확장 — 개인이 매스미디어급", plus: "시민 직접 참여, e-democracy", minus: "여론 조작, 선거 AI 개입" },
