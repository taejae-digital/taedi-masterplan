...
const chain = [
  ["질서 붕괴와 새 사회계약의 결론", "디지털 시대 새 사회계약은 정체성 실현의 자유를 보장해야 한다."],
  ["권리의 언어", "정체성 실현권, AI 인프라 평등 접근권, AI 개인화권, 시민 직접 위임 거버넌스가 필요하다."],
  ["경영의 언어", "권리는 선언으로 끝나지 않고 국가·도시·세계의 운영 원칙으로 번역되어야 한다."],
...
const managementRows = [
  ...
  {
    area: "세계 경영",
    p3: "빅테크·플랫폼·AI 규칙은 국경 밖에서 작동한다. 시민 직접 위임 거버넌스는 도시와 국가를 넘어 세계로 확장되어야 한다.",
    principle: "세계는 강대국 질서의 보조 장치가 아니라 디지털 권리와 AI 안전을 공동 검증하는 다층 거버넌스여야 한다.",
...
const rights = [
  ...
  ["시민 직접 위임 거버넌스", "세계", "플랫폼·AI 규칙을 시민·도시·국가가 공동 검증하는 구조"],
];

const questions = [
  ["국가", "이 정책은 성장률이나 산업 육성만 말하는가, 아니면 정체성 실현의 자유를 보장하는가."],
  ["도시", "이 도시는 개발사업인가, 아니면 개인이 자기 경로를 발견하고 훈련하고 실현하는가."],
  ["세계", "이 국제협력은 외교 행사인가, 아니면 디지털 권리와 AI 안전의 공동 규칙을 만드는가."],
    ...
    <div style={{ pageBreakBefore: "always", minHeight: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "9px 32px 6px", borderBottom: `2px solid ${C.navy}`, marginBottom: 8 }}>
        <div style={{ fontSize: 12.4, color: "#222", lineHeight: 1.42, fontWeight: 650 }}>
          <strong style={{ color: C.navy }}>질서 붕괴와 새 사회계약의 결론은 새 권리의 선언이 아니라 운영 원칙의 출발점이다.</strong> 정체성 실현의 자유를 보장하려면 국가·도시·세계 경영은 통제·개발·외교 행사를 넘어 개인의 발견·훈련·실현을 가능하게 하는 구조로 재편되어야 한다.
        </div>
      </div>

      <div style={{ padding: "0 32px 8px", display: "flex", flexDirection: "column", flex: 1, gap: 7 }}>
        <div>
          <div style={h3s}>4.1 새 사회계약이 경영 원칙으로 바뀌는 흐름</div>
        ...
        <div>
          <div style={h3s}>4.2 국가·도시·세계 경영 원칙</div>
        ...
        <div style={{ border: `1px solid ${C.navy}`, borderLeft: `6px solid ${C.accent}`, padding: "9px 15px", display: "flex", alignItems: "center", gap: 13 }}>
          ...
          <div style={{ fontSize: 15.2, lineHeight: 1.35, color: "#222", fontWeight: 700 }}>
            디지털 시대의 경영은 더 많이 통제하는 일이 아니다. <span style={{ color: C.accent, fontWeight: 900 }}>국가·도시·세계가 개인의 정체성 실현을 가능하게 만드는 운영 원칙을 갖추는 것</span>이다.
          </div>
        </div>
      </div>
