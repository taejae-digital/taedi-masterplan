...
export function IndividualCommunityPage() {
  return (
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      <Header subtitle="2. 디지털 전환에 따른 개인과 공동체 변화" version="v0.8.1" />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22, flex: 1, alignItems: "stretch" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ fontSize: 11.5, fontWeight: 800, color: C.navy, margin: "3px 0 5px", padding: "3px 0", borderBottom: `1.5px solid ${C.navy}` }}>2.2 디지털 시대 강화된 개인</div>
            ...
            {/* 오른쪽: 재구성되는 공동체 */}
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ fontSize: 11.5, fontWeight: 800, color: C.navy, margin: "3px 0 5px", padding: "3px 0", borderBottom: `1.5px solid ${C.navy}` }}>2.3 디지털 시대 재구성되는 공동체</div>
