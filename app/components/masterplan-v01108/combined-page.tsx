...
const contractResponsibilities = [
  ...
  { title: "조정 질서의 공정성 보장", detail: "플랫폼·조직·국가가 개인의 정체성 발휘 조건과 참여 기회를 일방적으로 제한하지 못하게 한다." },
];
          ...
          <SectionGrid spine={econSpine}>
            <div style={{ display: "flex", flexDirection: "column", gap: 6, height: "100%" }}> 
              <div style={{ padding: "7px 12px", background: "#fff", borderLeft: `3px solid ${C.ink}`, borderRadius: 2, fontSize: 12.0, lineHeight: 1.38, color: C.ink, fontWeight: 600 }}>
                산업시대에는 목적 설정과 생산 주도권이 리더에게 집중되었지만, 디지털 시대에는 프로가 정체성을 바탕으로 직접 생산을 주도하고 리더는 생산자 생태계를 조정한다. <span style={{ color: C.muted, fontWeight: 600 }}>에릭 브린욜프슨(스탠퍼드대)은 AI가 개인 생산성을 끌어올린다고 보고, 다니엘 서스킨드(킹스칼리지런던)는 AI가 일·소득·삶의 의미를 재설계하게 만든다고 본다.</span>
              </div>
              <div style={{ flex: 1 }}>
