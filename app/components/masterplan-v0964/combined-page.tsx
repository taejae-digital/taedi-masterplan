      ...
      <div style={{ padding: "6px 32px 8px", display: "flex", flexDirection: "column", flex: 1, gap: 7 }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
            ...
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                ...
                <th colSpan={3} style={{ padding: "4px 7px", textAlign: "center", fontSize: 11.5, borderBottom: "1px solid rgba(255,255,255,0.3)", background: C.accent }}>디지털시대: 새로운 경제질서</th>
              </tr>
              <tr style={{ background: C.navy, color: "#fff" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
            ...
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11.2 }}>새 권리</th>
                <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11.2 }}>핵심 정의</th>
                <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11.2 }}>작동하는 공동체</th>
                <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11.2 }}>경제·정치 차원</th>
                <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11.2 }}>국제 협력</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} style={{ background: i % 2 ? C.bg : "#fff" }}>
                  ...
                  <td style={{ padding: "5px 7px", borderBottom: "1px solid #eee", fontSize: 11, verticalAlign: "top", lineHeight: 1.3, color: "#333", fontWeight: 600 }}>{r.community}</td>
                  <td style={{ padding: "5px 7px", borderBottom: "1px solid #eee", fontSize: 11, verticalAlign: "top", lineHeight: 1.3, color: "#333" }}>{r.econPol}</td>
                  <td style={{ padding: "5px 7px", borderBottom: "1px solid #eee", fontSize: 10.8, verticalAlign: "top", lineHeight: 1.3, color: "#333" }}>{r.intl}</td>
                </tr>
              ))}
            </tbody>
          </table>
