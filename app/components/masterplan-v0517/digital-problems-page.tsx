    ...
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ padding: "14px 32px 10px", borderBottom: `2px solid ${C.red}`, marginBottom: 14, background: "#fff5f5" }}>
        <div style={{ fontSize: 17, fontWeight: 800, color: C.red, lineHeight: 1.4 }}>
          확장된 개인이 원하는 것 — 자율·의미·기여·인정 — 을 지금의 공동체 구조는 아직 담아내지 못한다.
          그 간극에서 위협이 자란다.
        </div>
        <div style={{ fontSize: 12.5, color: "#222", marginTop: 6, lineHeight: 1.65 }}>
          개인의 역량은 AI로 확장되었지만, 공동체의 설계는 산업화 시대에 머물러 있다.
          아래는 이 간극이 방치될 때 비가역으로 고착될 위험들이다.
        </div>
      </div>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 6 }}>
              {[
                {
                  tag: "진행중", color: C.red,
                  title: "폭력 독점의 균열 · 대량살상 수단의 확산",
                  desc: "AI가 생물·사이버·자율무기의 진입장벽을 소집단·개인 수준으로 낮추며 국가의 폭력 독점¹⁶에 균열을 낸다¹⁷. AI 기반 생화학무기는 핵보다 개발 비용이 낮으면서 피해 규모는 유사하거나 크다. 비가역적 공멸 가능성을 실질적으로 연다.",
                },
                {
                  tag: "진행중", color: C.red,
                  title: "허위정보 생태계 · 플랫폼 과두 · 디지털 권위주의 · 감시 자본주의¹⁸",
                  desc: "생성형 AI의 조작이 사실 합의 기반을 침식하고, 빅테크 독점이 국가 규제를 무력화한다. 감시·통제 기술이 권위주의 모델로 수출되며, 행동 데이터가 예측 상품으로 거래된다.",
                },
                {
                  tag: "임박", color: C.amber,
                  title: "자동화 실업 가속 · 선거 과정 AI 개입",
                  desc: "AI가 인지 노동까지 대체하는 속도는 수십 년이 아닌 수년 단위. 새 직종 창출이 따라잡지 못한다. 딥페이크·마이크로타게팅이 선거의 인식 기반을 조작한다.",
                },
                {
                  tag: "중기", color: C.accent,
                  title: "AI 정렬 문제²⁰ · 프로 계층 정체성 붕괴 · 미중 기술 패권 블록화",
                  desc: "능력이 우월한 시스템이 인간의 가치와 다른 목표를 추구할 때 통제 수단이 없다. 직업=정체성 공식의 붕괴로 존재론적 공백이 확산되고, 미중 블록화가 글로벌 조율 자체를 불가능하게 만든다.",
                },
                {
                  tag: "장기", color: C.navy,
                  title: "범용 AI 통제 불능 · 디지털 계급 구조 고착 · 지속불가능성",
                  desc: "초지능이 도래하면 인류는 그 시스템을 되돌릴 수 없다. 리더 5% / 프로 25% / 아마추어 65% / 소외 5%의 계층이 생물학적 수명 격차까지 수반하며 굳어지고, AI 데이터센터의 전력·용수·탄소 부담이 기후 목표와 충돌한다.",
                },
                ...
                <div key={title} style={{ display: "grid", gridTemplateColumns: "64px 1fr", border: `1px solid ${C.line}`, borderLeft: `4px solid ${color}` }}>
                  <div style={{ background: color, color: "#fff", padding: "6px 4px", fontSize: 11, fontWeight: 800, textAlign: "center", letterSpacing: 1, display: "flex", alignItems: "center", justifyContent: "center", lineHeight: 1.25 }}>{tag}</div>
