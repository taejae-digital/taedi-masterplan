...
const governanceAxes = [
  ...
  { label: "産", title: "생산·시장·산업 벨트", actors: "기업 · 핵심 산업", body: "AI·데이터·자본·시장·신뢰 인프라로 개인 생산자를 큰 시장에 연결한다.", shift: "대량생산 조직 → 개인 생산자의 시장 진입을 여는 산업 벨트 운영자" },
...
const small = [
  ...
  },
  {
    ...
    effect: "가정 경영은 보호 단위가 아니라 개인이 도시 생태계에서 탁월한 생산자로 성장하는 시스템이다. 앨리슨 고프닉(UC버클리)은 아이들이 지시된 수행보다 탐색과 놀이 속에서 세계 모델을 만들며 성장한다고 본다.",
  },
];
...
function NationSection() {
  return (
    <section>
      <SecHead no="4.2" area="디지털 시대의 국가 경영" desc="학·산·정·미디어 운영체계와 핵심 산업벨트를 조직한다." />
      ...
      <div style={{ color: C.ink, fontWeight: 800, fontSize: 12.5, marginBottom: 6 }}>핵심 산업의 역할과 지역 배치 — 4대 산업 벨트</div>
