...
export function PoliticalEconomicPage() {
  return (
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      {/* 3.3 — 5영역으로 보는 산업 질서의 파탄 */}
      <div style={{ padding: "10px 32px 0" }}>
        <div style={h3s}>3.3 5영역 강화가 산업 질서의 전제를 무너뜨린다</div>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          ...
          <tbody>
            {[
              {
                area: "판단력",
                pol: "전문가·관료 판단 권위 흔들림 — 위임 정당성의 근거가 약해진다",
                eco: "인지 노동 한계비용 0 수렴 — 전문직 기반 가격·소득 공식 붕괴",
              },
              {
                area: "생산성",
                pol: "다수 고용 전제 복지국가 위기 — 직업이 묶음 재편되며 과도기 소외 계층 발생",
                eco: "노동시간=소득 공식 붕괴, 자동화 이익이 데이터 독점자에 집중",
              },
              {
                area: "범위",
                pol: "직업=소속 기반 참정 구조 이완 — 다중 역할 개인이 단일 시민권 단위를 초과",
                eco: "분업·조직 중심 기업 모델 약화, 1인 묶음 직업이 니치마켓 분점",
              },
              {
                area: "접근성",
                pol: "학위·자격증 엘리트 선발 합의의 정당성 약화 — 진입장벽이 공정 기준이었다",
                eco: "진입장벽=가격 결정 공식 무력화, 플랫폼·모델 독점이 새 봉건제로",
              },
              {
                area: "영향력",
                pol: "1인 1표 무력화, 마이크로타게팅이 공론장을 사람마다 다른 현실로 분열",
                eco: "광고·미디어 경제 붕괴, 관심 경제 과두화로 부의 흐름이 비대칭화",
              },
            ].map(({ area, pol, eco }, i) => (
