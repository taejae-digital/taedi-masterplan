        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          ...
          <tbody>
            {[
              ...
              { lv: "진행 중", urg: true, area: "영향력·접근성", threat: "허위정보·플랫폼 과두", rx: "5.1-③ 알고리즘 자기결정권 + 5.2-③ AI 인프라 공공재화로 빅테크 독점 해체" },
              { lv: "임박", urg: false, area: "생산성·범위", threat: "직업 재편의 충격", rx: "5.1-① 정체성 실현권 + 재편 충격 완충 — 전환 인프라 구축, AI 이익 환수·환류, 시장 가치 너머 기여(돌봄·창작)에 분배·존엄 보장" },
              { lv: "임박", urg: false, area: "영향력", threat: "선거·공론장 AI 개입", rx: "5.1-③ 알고리즘 자기결정권 (설명 요구권·자동 판단 거부권) + 5.2-② FDA 모델로 고위험 시스템 사전 승인" },
              { lv: "중기", urg: false, area: "판단력", threat: "AI 정렬 문제", rx: "5.2-② FDA 모델 (개발자 안전 입증·외부 검증) + 5.2-③ 글로벌 한시 협력으로 통제 권한 확보" },
              { lv: "중기", urg: false, area: "범위", threat: "미중 기술 패권 블록화", rx: "5.2-③ 글로벌 한시 협력 — 미·중·EU·글로벌 사우스 공동 의제로 디지털 거버넌스 끌어올리기" },
              { lv: "장기", urg: false, area: "판단력", threat: "범용 AI 통제 불능", rx: "5.2-② FDA 모델 + 5.2-③ 글로벌 한시 협력으로 확산 이전 통제 레짐 확보" },
              { lv: "장기", urg: false, area: "접근성·생산성", threat: "디지털 계급 고착·지속불가능성", rx: "5.1-② AI 인프라 평등 접근권 + 5.1-① 정체성 실현권 + 5.2-③ 공공 인프라로 환경·자원 사회화" },
            ].map((r, i) => (
