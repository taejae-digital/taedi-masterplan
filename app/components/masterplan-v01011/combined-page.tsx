    ...
    <div style={{ pageBreakBefore: "always", minHeight: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "11px 38px 13px", display: "flex", flexDirection: "column", flex: 1, gap: 12 }}>
        <div style={{ padding: "8px 12px", background: "#f0f4ff", borderLeft: `4px solid ${C.navy}`, fontSize: 13.2, lineHeight: 1.28, color: "#222", fontWeight: 610 }}>
          AI·데이터·컴퓨팅·플랫폼은 새 생산수단이 되고, 정체성은 생산과 기여의 기준이 된다. 이 자원이 플랫폼과 자본에 집중되면 정체성 실현은 새 계급질서로 굳어진다. 새 사회계약은 형성·생산·시장·인정·조정의 운영 구조로 그 격차를 막는다.
        </div>
...
const td33: React.CSSProperties = { padding: "3px 6px", borderBottom: "1px solid #eee", fontSize: 10.8, verticalAlign: "middle", lineHeight: 1.24, color: "#333", height: 48 };
const td33Inner: React.CSSProperties = { height: "3.72em", lineHeight: 1.24, overflow: "hidden", display: "flex", alignItems: "center" };
