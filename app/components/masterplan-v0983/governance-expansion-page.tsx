...
const chain = [
  ["개인 변화", "AI가 인지노동을 대체하면서 개인은 생계·안정성·학력·시장 수요를 넘어 자기 정체성을 발견·훈련·실현해야 한다."],
...
const conditions = [
  ...
  ["제도 역량", "7대분야 초일류 역량 확보", "산업시대에는 분업화된 7대 분야의 전문성·조직력 최정상화가 초일류 역량이었다. 디지털시대에는 싱크탱크·대학·기업·미디어·정부·정당·군대가 정체성 발견·훈련·실현을 가능하게 하는 사회 운영 플랫폼으로 혁신되어야 한다."],
