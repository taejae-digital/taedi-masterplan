...
export function Header({ subtitle, version = "v0.3" }: { subtitle: string; version?: string }) {
  return (
...
export const ps: React.CSSProperties = { margin: "0 0 9px", fontSize: 14, lineHeight: 1.85, color: "#222", textAlign: "justify" };
export const h3s: React.CSSProperties = { fontSize: 14, fontWeight: 800, color: "#1a2744", margin: "16px 0 6px", paddingBottom: 3, borderBottom: "1px solid #ddd" };
