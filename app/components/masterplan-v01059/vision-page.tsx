...
const ps: React.CSSProperties = { margin: "0 0 12px", fontSize: 14.0, lineHeight: 1.9, color: "#222", textAlign: "justify" };
const h3: React.CSSProperties = { ...h3s, fontSize: 18.2, margin: "18px 0 9px", paddingBottom: 5 };
...
export function VisionPage() {
  return (
    <div style={{ height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 32px 12px", borderBottom: `2px solid ${C.navy}`, marginBottom: 10 }}>
        <div style={{ fontSize: 11.8, letterSpacing: 4, color: C.light, fontWeight: 700, marginBottom: 6 }}>VISION</div>
        <div style={{ fontSize: 15.2, fontWeight: 850, color: C.navy, lineHeight: 1.32 }}>
          디지털 시대는 생산능력의 개인화로 경제를 다양화하고, 강화된 개인에게 더 큰 자유를 요구한다. 새 사회계약은 그 자유가 공동체 안에서 충돌하지 않고 조화되도록 설계하며, 이를 세계·국가·도시·가정 경영으로 실행한다.
        </div>
        <div style={{ marginTop: 7, fontSize: 12.8, lineHeight: 1.55, color: "#333", fontWeight: 560 }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 28, rowGap: 0, flex: 1 }}>
        <div>
        ...
        <div>
          <div style={h3}>1.3 새로운 사회계약 — 정체성이 고유한 기여로 전환될 여건을 보장한다</div>
          <p style={ps}>
