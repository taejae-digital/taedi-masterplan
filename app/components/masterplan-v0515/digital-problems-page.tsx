          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 6 }}>
              {[
                {
                  tag: "진행중", color: C.red,
                  title: "폭력 독점의 침식 · 대량살상 수단의 확산",
                  desc: "AI가 생물·사이버·자율무기의 진입장벽을 소집단·개인 수준으로 낮추며 국가의 폭력 독점을 침식한다. AI 기반 생화학무기는 핵보다 개발 비용이 낮으면서 피해 규모는 유사하거나 크다. 비가역적 공멸 가능성을 실질적으로 연다.",
                },
                {
                  tag: "진행중", color: C.red,
