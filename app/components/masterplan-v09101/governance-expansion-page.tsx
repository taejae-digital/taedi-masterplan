...
const limitRows = [
  {
    title: "AI 패권경쟁",
    limit: "미국과 중국은 모두 AI 패권국가다. 미국은 빅테크·달러 금융·클라우드·반도체 설계·동맹망으로, 중국은 국가 전략·제조망·전력 인프라·로봇·EV·배터리·플랫폼 통제로 AI 질서를 확장한다.",
    strategy: "경쟁 중단을 요구하지 않는다. 안전 사고, 시장 분열, 정당성 위기, 동맹 피로, 국내 불안이라는 패권 비용이 커지는 지점에 공멸선을 긋고, 그 위에 시민강화 표준을 얹는다.",
  },
  {
    title: "한국의 패권 모델",
    limit: "한국은 미국식 빅테크 패권도, 중국식 국가감시 패권도, 독점기업 중심의 반민주적 기술 엘리트주의도 따를 수 없다. 약한 조정자 역할만으로도 세계 질서를 바꿀 수 없다.",
    strategy: "한국은 AI 시민강화 표준을 선점하는 중심 국가가 되어야 한다. AI가 시민을 대체하거나 감시하지 않고, 시민의 능력·권리·정체성 실현을 강화하는 질서를 산업·제도·도시·가정에서 먼저 증명한다.",
  },
  {
    title: "산업 기반의 재해석",
    limit: "15대 산업을 단순 먹거리나 기술 목록으로 보면 패권 전략이 되지 않는다. 산업이 사회계약의 구현 장치로 묶이지 않으면 세계가 따를 표준을 만들 수 없다.",
    strategy: "미래창조형, 세계정상필수, 동북아·한반도 정체성기반 산업을 하나의 운영체계로 묶는다. 산업은 시민강화 AI를 도시·주거·공공재·제조·미디어·금융·교육·건강·국토에 실증하는 물적 기반이다.",
  },
  {
    title: "제도 권력의 부족",
    limit: "기술과 산업만으로는 세계 질서를 재편할 수 없다. 규칙을 만들고, 인재를 키우고, 서사를 확산하고, 법·예산·안보로 실행할 제도 권력이 필요하다.",
    strategy: "싱크탱크·대학·기업·미디어·정부·정당·군대의 7대 분야를 초일류화한다. 7대 분야가 산업 실증을 세계 표준과 국가 권력으로 바꾸는 제도 권력이다.",
  },
];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
            {limitRows.map((row, i) => (
              <div key={row.title} style={{ minHeight: 245, display: "flex", flexDirection: "column", border: `1px solid #d8d2ca`, background: i % 2 ? C.bg : "#fff" }}>
                ...
                <div style={{ padding: "8px 10px 10px", borderTop: "1px solid #e5ddd2", fontSize: 10.9, lineHeight: 1.25, color: C.accent, fontWeight: 700, flex: 1 }}>
