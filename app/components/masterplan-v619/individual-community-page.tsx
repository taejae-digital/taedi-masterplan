          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 10, fontSize: 12.5 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12, width: "18%" }}>시대</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>생산 단위</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>정체성의 근거</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>삶의 공식</th>
              </tr>
            </thead>
            <tbody>
              {[
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 8, fontSize: 12 }}>
            <thead>
              <tr style={{ background: C.accent, color: "#fff" }}>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5, width: "16%" }}>기술</th>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5 }}>원한 자유</th>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5 }}>제도화된 권리</th>
              </tr>
            </thead>
            <tbody>
              {[
        ...
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 10, fontSize: 12.5 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12, width: "18%" }}>시대</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>중심 공동체</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>조율 방식</th>
                <th style={{ padding: "5px 7px", textAlign: "left", fontSize: 12 }}>위임의 논리</th>
              </tr>
            </thead>
            <tbody>
              {[
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 8, fontSize: 12.5 }}>
            <thead>
              <tr style={{ background: C.accent, color: "#fff" }}>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5, width: "18%" }}>공동체</th>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5 }}>산업시대 역할</th>
                <th style={{ padding: "4px 6px", textAlign: "left", fontSize: 11.5 }}>디지털시대 재균형</th>
              </tr>
            </thead>
            <tbody>
              {[
