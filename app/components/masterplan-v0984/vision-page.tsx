...
const flow = [
  ...
  },
  {
    ...
    d: "개인이 더 많은 일을 직접 할 수 있게 되면, 직업은 개인을 규정하지 못하고 ‘나는 누구로 기여할 것인가’가 핵심 질문이 된다.",
    bg: "#fff8f4",
    c: C.red,
  },
  {
    k: "1.3 새 사회계약",
    t: "정체성 기여를 새 질서로 인정한다",
    d: "가치의 기준이 노동시간에서 고유한 기여로 이동하므로, 디지털 인프라 접근·직접 참여·정체성 실현을 권리로 보장한다.",
    bg: "#f0f5ff",
    c: "#2563eb",
  },
  {
    ...
    <div style={{ height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        <div>
          ...
          <p style={ps}>
            디지털시대에는 이 틀이 약해진다. AI가 분석·창작·기획·실행 능력을 개인에게 이전하면, 한 사람이 여러 직업의 기능을 동시에 수행하고 과거 조직 단위의 산출에 도달할 수 있다. 직업은 더 이상 개인의 가능성을 고정적으로 설명하지 못한다. 그때 개인에게 남는 질문은 “무슨 직업을 가질 것인가”가 아니라 <strong>“어떤 정체성으로 기여할 것인가”</strong>다.
          </p>
        ...
        <div>
          <p style={ps}>
            디지털시대에는 이 전제가 흔들린다. 산업시대에는 같은 시간, 같은 공정, 같은 직무를 수행하는 노동이 가치 측정의 중심이었다. 그러나 AI가 정형화된 인지노동을 대체하면, 단순히 오래 일하는 것보다 무엇을 문제로 정의하고, 어떤 관점으로 연결하며, 누구에게 필요한 결과를 만들어내는지가 더 중요해진다. 여기서 정체성은 취향이나 자기표현이 아니라 <strong>개인이 세상을 이해하고 문제를 선택하며 기여 방식을 결정하는 고유한 기준</strong>이다. 그래서 가치는 노동시간이 아니라 정체성에 기반한 기여에서 나온다.
          </p>
          <p style={ps}>
