      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            ...
            산업화는 인간의 근육을 대체해 조직 관리자를 만들었다. 디지털·AI는 두뇌를 대체·보완하며 <strong>AI와 함께 설계하는 혁신가</strong>를 요구한다.
          </div>
              ...
              {[
                {
                  ...
                  ageColor: false,
                  rows: [
                    { level: "리더", task: "위계 질서의 정당화", tech: "위계를 신성화한 종교", expert: "의례·통치의 권위", ideal: "덕망 있는 권위자 | 신분 제약 없이 덕이 인정받을 자유" },
                    { level: "프로", task: "세대 간 지식의 전승", tech: "기록을 가능케 한 문자", expert: "경험의 축적과 전승", ideal: "지혜로운 원로 | 지식을 독점 없이 전승할 자유" },
                    { level: "아마추어", task: "식량 생산의 안정화", tech: "물을 다스리는 관개술", expert: "체화된 생산의 기예", ideal: "건강하고 부지런한 일꾼 | 기근과 착취로부터의 생존 자유" },
                  ],
                },
                {
                  age: "산업",
                  ageColor: false,
                  rows: [
                    { level: "리더", task: "대규모 조직의 운영·자본 조달", tech: "분업을 제도화한 관료제·조립라인", expert: "생산 시스템을 소유하고 설계", ideal: "산업을 개척하는 기업가 | 자본 접근과 시장 진입의 자유" },
                    { level: "프로", task: "공간·시간의 압축·분과 전문화", tech: "거리를 좁힌 철도·전신", expert: "분과별 심화 전문성", ideal: "노련한 분과 전문가 | 전문성으로 조직 내 이동할 자유" },
                    { level: "아마추어", task: "인간 근력의 한계 극복", tech: "에너지를 생산하는 동력기관", expert: "정형화된 반복 노동", ideal: "성실한 숙련 노동자 | 노동 조건을 협상할 자유" },
                  ],
                },
                {
                  age: "디지털",
                  ageColor: true,
                  rows: [
                    { level: "리더", task: "플랫폼·AI 거버넌스·가치 정렬 설계", tech: "AI·플랫폼 인프라·정렬 기술", expert: "기술이 추구할 목적과 생태계 규칙 설계", ideal: "AI와 함께 설계하는 혁신가 | 플랫폼 종속 없이 미션을 정의할 자유" },
                    { level: "프로", task: "디지털 시스템 구축·AI 감독·제도 설계", tech: "소프트웨어·AI 감독·데이터 분석", expert: "기술과 창의를 결합한 가치 생산·비판적 평가", ideal: "개발자·AI 감독자 | 알고리즘 편향 없이 전문성을 키울 자유" },
                    { level: "아마추어", task: "디지털 도구·AI 활용·데이터 생산", tech: "생성 AI·플랫폼·SNS", expert: "AI와 협업하며 삶의 목적을 설계", ideal: "자율적 디지털 시민 | AI를 도구로 삼아 정체성을 설계할 자유" },
                  ],
                },
                ...
                <tr key={i} style={{ background: ageColor ? "#f0f4ff" : i % 6 < 3 ? "#fff" : C.bg }}>
                  ...
                  <td style={{ padding: "4px 6px", borderBottom: "1px solid #f0f0f0", color: "#222", fontWeight: ageColor && level === "리더" ? 700 : 500, lineHeight: 1.45, verticalAlign: "top" }}>{ideal.split(" | ")[0]}</td>
                  <td style={{ padding: "4px 6px", borderBottom: "1px solid #f0f0f0", color: "#555", fontStyle: "italic", fontSize: 11, lineHeight: 1.45, verticalAlign: "top" }}>{ideal.split(" | ")[1] || ""}</td>
                </tr>
              ))}
            </tbody>
          </table>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: "#333" }}>
            <strong style={{ color: C.navy }}>계층이 시대를 만든다 —</strong> 농업시대는 <strong>위계의 권위자</strong>가, 산업시대는 <strong>산업을 개척하는 기업가</strong>가 시대를 정의했다. 디지털 시대는 <strong>AI와 함께 설계하는 혁신가</strong>가 그 자리를 맡는다. AI는 도구다 — 그 도구를 어떻게 쓸지 설계하는 자가 다음 시대를 만든다. <strong>먼저 풀어야 할 문제를 보면, 그 문제를 푸는 자가 보이고, 거기에 맞는 정체성이 발견된다.</strong>
          </div>
        </div>
