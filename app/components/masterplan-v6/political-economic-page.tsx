    ...
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 13.5, fontWeight: 700, color: C.dark, margin: "8px 0 6px" }}>산업화 시대의 답</div>
          ...
          <p style={{ ...ps, fontSize: 13.5 }}>
            ...
            <span style={{ display: "block", marginTop: 5, paddingLeft: 12, fontSize: 12.5, fontStyle: "italic", color: C.light, borderLeft: `2px solid ${C.line}` }}>
          ...
          <div style={{ fontSize: 13.5, fontWeight: 700, color: C.dark, margin: "12px 0 6px" }}>왜 산업화 시대에는 맞았는가</div>
          <p style={{ ...ps, fontSize: 13.5 }}>
          ...
          <div style={{ fontSize: 13.5, fontWeight: 700, color: C.red, margin: "12px 0 6px" }}>왜 디지털 시대에는 맞지 않는가</div>
          <div style={{ padding: "8px 10px", background: C.bg, borderLeft: `3px solid ${C.line}` }}>
            {[
              ...
              <div key={t} style={{ display: "flex", gap: 8, marginBottom: 5, fontSize: 12.5, lineHeight: 1.6 }}>
      ...
      <div style={{ padding: "14px 32px 0", marginTop: 10 }}>
        ...
        <p style={{ ...ps, fontSize: 13.5, marginTop: 10 }}>
