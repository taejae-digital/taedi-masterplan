    ...
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, flex: 1 }}>
        ...
        <div>
          ...
          {[
            { n: "①", t: "개발자 입증 책임 (FDA 레짐)", d: "AI 출시 전 안전 입증·사전 승인. 위험을 가장 잘 아는 개발자에게 입증 책임 귀속." },
            { n: "②", t: "과업 한정 한시 위임 (WHO 모델)", d: "위기별 권한이 위기 해소 시 자동 해체. 권력의 영구화 차단." },
            { n: "③", t: "역량·기여 기반 분배", d: "자본·노동시간이 아닌 문제해결·돌봄·창의·판단 기준. AI 부의 사회 환류." },
          ].map(({ n, t, d }) => (
