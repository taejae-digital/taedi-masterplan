...
export function Header({ subtitle, version = "v0.6.4" }: { subtitle: string; version?: string }) {
  return (
...
export const ps: React.CSSProperties = { margin: "0 0 10px", fontSize: 13, lineHeight: 1.85, color: "#222", textAlign: "justify" };
export const h3s: React.CSSProperties = { fontSize: 13.5, fontWeight: 800, color: "#1a2744", margin: "14px 0 7px", paddingBottom: 3, borderBottom: "1px solid #ddd" };
