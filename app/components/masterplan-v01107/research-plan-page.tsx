...
const objectives = [
  ...
  },
  {
    ...
    krs: ["정체성을 고유한 기여로 발휘할 기본 여건(생활·생산·조정)의 보장 구조 확정", "생산수단 개방·기여 경로 연결·플랫폼 권력 조정의 핵심 합의 정리", "AI 인프라 접근권·개인화권·설명/거부/조정 UI의 법제 쟁점 정리", "EU DMA·AI Act·GDPR 분석 후 한국형 디지털 사회계약 적용안 제시"],
  },
];
