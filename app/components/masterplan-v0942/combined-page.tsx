    ...
    <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
      ...
      <thead>
        <tr style={{ background: C.navy, color: "#fff" }}>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>① 산업시대가 만든 것</th>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>② 디지털이 바꾸는 것</th>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>③ 그래서 무너지는 것</th>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>④ 그래서 새로 만들어야 할 것</th>
        </tr>
      </thead>
      <tbody>
        {rows.map((r, i) => (
