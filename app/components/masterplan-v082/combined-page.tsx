            ...
            <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
              ...
              <thead>
                <tr style={{ background: C.navy, color: "#fff" }}>
                  <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11 }}>산업화 시대</th>
                  <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11 }}>AI 시대의 타격</th>
                  <th style={{ padding: "4px 7px", textAlign: "left", fontSize: 11 }}>구체적 위협 예시</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ background: i % 2 ? C.bg : "#fff" }}>
                    ...
                    <td style={{ padding: "4px 7px", borderBottom: "1px solid #eee", fontSize: 14, verticalAlign: "top", lineHeight: 1.5, color: "#333" }}>{impact}</td>
                    <td style={{ padding: "4px 7px", borderBottom: "1px solid #eee", verticalAlign: "top" }}>
                      {threats.map((t, j) => (
                        <div key={j} style={{ marginBottom: j < threats.length - 1 ? 4 : 0 }}>
                          <span style={{ fontSize: 14, color: "#333", lineHeight: 1.4 }}>{t.text}</span>
                        </div>
                      ))}
                    </td>
                  </tr>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
            ...
            <div style={{ padding: "5px 10px", background: "#fafafa", borderLeft: "3px solid #ccc", borderRadius: 2 }}>
              ...
              <div style={{ fontSize: 14, color: "#7c3aed", fontWeight: 600, marginTop: 4 }}>거버넌스 단위: 도시·협동조합·디지털 공동체</div>
            </div>
            ...
            <div style={{ padding: "5px 10px", background: "#fafafa", borderLeft: "3px solid #ccc", borderRadius: 2 }}>
              ...
              <div style={{ fontSize: 14, color: "#2563eb", fontWeight: 600, marginTop: 4 }}>거버넌스 단위: 국가·공공 AI 인프라·국제 표준</div>
            </div>
            ...
            <div style={{ padding: "5px 10px", background: "#fafafa", borderLeft: "3px solid #ccc", borderRadius: 2 }}>
              ...
              <div style={{ fontSize: 14, color: C.accent, fontWeight: 600, marginTop: 4 }}>거버넌스 단위: 민주국가 연합·세계시민 거버넌스</div>
            </div>
