...
const s = {
  cell: { padding: "6px 8px", borderBottom: "1px solid #eee", verticalAlign: "top" as const, fontSize: 13.5, lineHeight: 1.5 },
  link: { padding: "6px 8px", borderBottom: "1px solid #eee", verticalAlign: "top" as const, fontSize: 12, lineHeight: 1.45, color: "#444" },
  hcell: { padding: "5px 8px", borderBottom: "2px solid #333", fontSize: 12, fontWeight: 700 as const, textAlign: "left" as const },
  h2: { fontSize: 16, fontWeight: 800 as const, color: C.dark, marginBottom: 6, paddingBottom: 3, borderBottom: "2px solid #333" },
  row: { display: "flex" as const, gap: 6, marginBottom: 3, fontSize: 13.5, lineHeight: 1.5 },
  stag: { fontWeight: 700 as const, color: C.dark, fontSize: 12, minWidth: 52, flexShrink: 0 as const },
  section: (num: string, text: string) => (
    <div style={{ fontSize: 19, fontWeight: 800, color: C.dark, marginBottom: 12, paddingLeft: 2, paddingBottom: 5, borderBottom: "1px solid #ccc" }}>{num}. {text}</div>
  ),
};
    ...
    <div style={{ pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ borderBottom: `3px solid ${C.dark}`, paddingBottom: 6, marginBottom: 14 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div>
            <h1 style={{ fontSize: 28, fontWeight: 800, margin: 0, lineHeight: 1.2 }}>디지털이 초래할 위험성과 그 대책</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 20 }}>
        <div>
          ...
          <div style={{ fontSize: 14, lineHeight: 1.7, color: "#333", marginTop: 6 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ flex: 1, background: "#fff8f0", border: "0.5px solid #f0c080", borderRadius: 6, padding: "6px 10px", fontSize: 12.5, lineHeight: 1.5 }}>
            ...
            <div style={{ flex: 1, background: "#f0f7ff", border: "0.5px solid #80b8f0", borderRadius: 6, padding: "6px 10px", fontSize: 12.5, lineHeight: 1.5 }}>
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: 11, color: C.light }}>Perez(2002) 기술혁명 황금기 · Polanyi(1944) 시장 팽창과 사회 자기보호 · Acemoglu &amp; Johnson(2023) 기술의 민주적 재방향화</p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: 20 }}>
        <div>
          ...
          <p style={{ margin: "4px 0 0", fontSize: 12, color: C.gray }}>"무슨 일 하세요?"에 답할 수 없는 사람이 다수가 된다. 경제적 위기이자 존재론적 위기.</p>
        </div>
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, lineHeight: 1.4 }}>
            ...
            <tbody>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>상용 드론+컴퓨터비전 AI, 오픈소스 LLM 기반 전술 자동화</td>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>AlphaFold2·3, ProteinMPNN, RFdiffusion</td>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>LLM 기반 취약점 탐색(PentestGPT류), 자율 익스플로잇 생성</td>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>자율표적선정 AI(LAWS), 핵 지휘통제 자동화 시스템</td>
              ...
              <tr>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>추천 알고리즘, 딥페이크, 마이크로타기팅 LLM</td>
              ...
              <tr>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>자율 AI 에이전트, 강화학습 기반 목표 최적화</td>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>GPU 클러스터 독점, 파운데이션 모델 API 종속</td>
              ...
              <tr style={{ background: "#f5f5f5" }}>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>GPU 클러스터 독점, 데이터 네트워크 효과</td>
              ...
              <tr>
                ...
                <td style={{ ...s.cell, fontSize: 11.5, color: "#777" }}>클라우드 인프라의 초국경성, 데이터 흐름의 탈국경화</td>
  ...
  return (
    <div>
      <div style={{ borderBottom: `2px solid ${C.dark}`, paddingBottom: 6, marginBottom: 14, marginTop: 20 }}>
        <h2 style={{ fontSize: 24, fontWeight: 800, margin: 0 }}>대책 · 실행 계획</h2>
      </div>
      ...
      <div style={{ padding: "10px 14px", background: "#f8f9fa", borderLeft: "4px solid #333", marginBottom: 14 }}>
        ...
        <p style={{ margin: "6px 0 0", fontSize: 11, color: C.light }}>Ostrom(1990) 공유자원도 자치 규칙으로 관리 가능 · Schelling(1960) 상호 이익이 되는 초점에서 협력이 발생</p>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 14, marginBottom: 14 }}>
        <div style={{ padding: "10px 12px", borderTop: "4px solid #b91c1c" }}>
          ...
          <p style={{ margin: "6px 0 0", fontSize: 11, color: C.light }}>Payne(2026) AI 군비 경쟁이 억지력 균형을 파괴하는 메커니즘</p>
        </div>
        <div style={{ padding: "10px 12px", borderTop: "4px solid #d97706" }}>
          ...
          <p style={{ margin: "6px 0 0", fontSize: 11, color: C.light }}>Russell(2019) AI는 항상 인간이 번복할 수 있어야 한다</p>
        </div>
        <div style={{ padding: "10px 12px", borderTop: "4px solid #16a34a" }}>
          ...
          <p style={{ margin: "6px 0 0", fontSize: 11, color: C.light }}>Mazzucato(2013) 국가가 혁신의 주체가 되어야 한다 · Polanyi(1944) 시장이 팽창하면 사회가 자기보호한다</p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 16 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 13.5, lineHeight: 1.7, color: "#333", marginTop: 6 }}>
