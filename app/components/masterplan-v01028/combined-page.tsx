...
export function CombinedPage() {
  ...
  const polSpine = [
    { k: "기존 질서", t: "국가 독점 정치", d: "국가는 표준 규칙을 만들고, 국민은 선거로 권한을 장기 위임" },
    { k: "디지털 변화", t: "정치 기능의 양방향 재배치", d: "실행은 도시가 중심, AI·데이터·플랫폼 규칙은 세계정부 의제로 이동" },
    { k: "새 질서", t: "도시 중심 실행과 세계정부 규칙", d: "도시는 생활정치를 운영하고, 세계정부는 공통 규칙을 세우며, 국가는 연결" },
  ];
        ...
        <div>
          ...
          <SectionGrid spine={polSpine}>
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <div style={{ padding: "4px 8px", background: "#f3f6fb", borderLeft: `3px solid ${C.navy}`, fontSize: 10.7, lineHeight: 1.18, color: "#2b3342", fontWeight: 650 }}>
                디지털 시대 정치 기능은 국가 독점에서 도시와 세계정부로 재배치된다. 생활정치와 실행은 도시가 중심이 되고, AI·데이터·플랫폼의 초국가 규칙은 세계정부가 맡으며, 국가는 둘을 연결한다.
              </div>
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
