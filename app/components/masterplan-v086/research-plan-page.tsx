          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 7 }}>
              {[
                ...
                { name: "이규환", role: "새 권리 (B) · 새 질서 (C)", detail: "AI 인프라 평등 접근권·알고리즘 자기결정권 (B), 다층 거버넌스·전력·용수 규제 (C)." },
                { name: "윤준영", role: "새 질서 (C) · 평가 협력 (D)", detail: "글로벌 한시 협력·미중 경로 (C), FDA 사전 승인 체계 (D), Law Zero·ARIA 네트워킹." },
