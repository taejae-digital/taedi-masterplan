    ...
    <div style={{ height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps086}>
            이 재구성은 산업 시대의 사회계약 위에 무엇을 덧대는 작업이 아니라, <strong>민주주의와 자본주의를 디지털 시대의 강화된 개인이 작동할 수 있는 형태로 재설계하는 작업</strong>이다. 영토 시민의 표를 단위로 한 민주주의는 한 국가에 귀속되지 않는 강화된 개인을 대표할 수 없고, 임금노동의 기여를 분배의 기준으로 삼은 자본주의는 직업이 정체성을 보장하지 못하는 시대의 가치를 측정할 수 없다. <strong>무엇이 민주주의의 대표성을 확장하여 강화된 개인의 정치 참여를 매개할 것인가, 무엇이 자본주의의 분배 원리를 재구성하여 정체성 실현 시대의 분배를 작동시킬 것인가</strong> — 이 두 질문이 새 사회계약의 출발점이다.
          </p>
          <p style={ps086}>
