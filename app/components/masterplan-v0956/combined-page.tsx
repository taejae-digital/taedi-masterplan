...
const classRows: ClassRow[] = [
  {
    ...
    digital: {
      production: "AI 시스템 설계·전략 지휘, 강화 최대 수혜",
      distribution: "AI 자본·데이터 이익 집중 (과세 대상)",
      consumption: "정체성 실현 자유 — 다중 도시·경험 소비",
    },
  },
  {
    label: "프로",
    ...
    digital: {
      production: "AI 증강 생산, 1인 다중 직업 가능",
      distribution: "정체성 기여 인정 분배, 전문성 독점 해체로 축소",
      consumption: "정체성 실현 지출 — 강소도시 구독, 맞춤 서비스",
    },
  },
  {
    label: "아마추어",
    ...
    digital: {
      production: "AI 활용 1인 생산 — 매스미디어급 도달",
      distribution: "디지털 배당 + 수익화 상위 1% (롱테일)",
      consumption: "정체성별 다양한 경로, 강소도시 구독",
    },
  },
  {
    label: "소외",
    ...
    digital: {
      production: "AI 배제로 생산 참여 불가 — 격차 절대화",
      distribution: "안전망 + AI 인프라 평등 접근으로 보장",
      consumption: "기본 생존 + 정체성 발견·훈련 지원",
    },
  },
];
      ...
      <div style={{ padding: "8px 32px 16px", display: "flex", flexDirection: "column", flex: 1, gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11.5, color: "#222", lineHeight: 1.55, padding: "6px 10px", background: "#f0f4ff", borderLeft: `3px solid ${C.navy}`, marginBottom: 6 }}>
            <strong style={{ color: C.navy }}>산업시대 경제는 노동가치설 위에 섰다.</strong> 디지털시대는 <strong>정보·지능의 대중화</strong>가 노동의 가치 원천 지위를 흔든다. 가치는 노동 시간에서 <strong>정체성 기여</strong>로 옮겨간다. 같은 4계층(리더·프로·아마추어·소외)이 산업시대와 디지털시대에 <strong>역할과 비중이 달라진다</strong>.
          </div>
          <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
            <colgroup>
              <col style={{ width: "11%" }} />
