  ...
  return (
    <div style={{ pageBreakBefore: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "10px 32px 8px", borderBottom: `2px solid ${C.navy}`, marginBottom: 8 }}>
        <div style={{ fontSize: 13, letterSpacing: 4, color: C.accent, fontWeight: 800, marginBottom: 4 }}>제1기계 시대는 근육을 대체했다. 제2기계 시대는 두뇌를 대체한다 — 요구되는 인재상이 근본적으로 달라진다</div>
        <div style={{ fontSize: 18, fontWeight: 800, color: C.navy, lineHeight: 1.35 }}>
          새 시대의 문제가 먼저 보여야, 그 문제를 풀 직업이 나오고, 그 직업에 맞는 정체성을 발견할 수 있다.
          제1기계 시대는 조직 관리자를 만들었지만, 제2기계 시대는 <strong>기계와 함께 달리는 혁신가</strong>를 요구한다.
        </div>
      </div>
      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            ...
            제1기계 시대(산업)는 근육을 대체해 조직 관리자를 만들었다. 제2기계 시대(디지털·AI)는 두뇌를 대체·보완하며 <strong>기계와 함께 달리는 혁신가</strong>를 요구한다.
          </div>
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  ageColor: false,
                  rows: [
                    { level: "리더", task: "대규모 조직의 운영·자본 조달", tech: "분업을 제도화한 관료제·조립라인", expert: "생산 시스템을 소유하고 설계", ideal: "산업을 개척하는 기업가" },
                    { level: "프로", task: "공간·시간의 압축·분과 전문화", tech: "거리를 좁힌 철도·전신", expert: "분과별 심화 전문성", ideal: "노련한 분과 전문가" },
                ...
                },
                {
                  ...
                  ageColor: true,
                  rows: [
                    { level: "리더", task: "플랫폼·AI 거버넌스·가치 정렬 설계", tech: "AI·플랫폼 인프라·정렬 기술", expert: "기술이 추구할 목적과 생태계 규칙 설계", ideal: "기계와 함께 달리는 혁신가" },
                    { level: "프로", task: "디지털 시스템 구축·AI 감독·제도 설계", tech: "소프트웨어·AI 감독·데이터 분석", expert: "기술과 창의를 결합한 가치 생산·비판적 평가", ideal: "개발자·AI 감독자" },
                    { level: "아마추어", task: "디지털 도구·AI 활용·데이터 생산", tech: "생성 AI·플랫폼·SNS", expert: "AI와 협업하며 삶의 목적을 설계", ideal: "자율적 디지털 시민" },
                  ],
                },
          ...
          <div style={{ fontSize: 12, lineHeight: 1.5, color: "#333" }}>
            <strong style={{ color: C.navy }}>계층이 시대를 만든다 —</strong> 농업시대는 <strong>위계의 권위자</strong>가, 제1기계 시대는 <strong>산업을 개척하는 기업가</strong>가 시대를 정의했다. 제2기계 시대는 <strong>기계와 함께 달리는 혁신가</strong>가 그 자리를 맡는다. AI는 도구다 — 그 도구를 어떻게 쓸지 설계하는 자가 다음 시대를 만든다. <strong>먼저 풀어야 할 문제를 보면, 그 문제를 푸는 자가 보이고, 거기에 맞는 정체성이 발견된다.</strong>
          </div>
        </div>
