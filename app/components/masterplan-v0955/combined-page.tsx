...
const econRows: Row[] = [
  ...
  {
    dim: "계층",
    prev: "자본가 · 관리자 · 숙련공 · 미숙련 노동자 — 소유·관리·노동 위계",
    why: "직업 계층 와해. AI 인지노동 대체로 산업시대 위계가 가치를 보장하지 못함",
    shift: "강화 위치로 갈라지는 새 4계층 — 리더(AI 지휘) · 프로(AI 증강) · 아마추어(AI 의존) · 소외(AI 배제)",
    next: "직업 계층이 아닌 정체성 단계(발견·훈련·실현)로 재편 — 단계별 기여를 분배 근거로, 소외 계층은 안전망 + AI 인프라 평등 접근으로 보장",
  },
];
