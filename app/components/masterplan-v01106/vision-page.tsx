...
export function VisionPage() {
  return (
    <div style={{ minHeight: "281mm", display: "flex", flexDirection: "column", background: "#fff" }}>
      ...
      <PageLead
        kicker="VISION"
        thesis="디지털 시대는 생산능력의 개인화로 경제를 다양화하고, 강화된 개인은 더 큰 자유를 필요로 한다."
      ...
      <div style={{ padding: "6px 48px 0", display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 42, rowGap: 18, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            문제는 이 다양성이 그냥 두면 협업이 아니라 파편화와 격차로 흩어진다는 점이다. AI·데이터·컴퓨팅 접근이 없거나, 플랫폼 추천에만 노출되거나, 시장과 연결되지 않으면 정체성은 고유한 기여로 이어지지 못한다. 새 사회계약은 개인의 자유를 줄이는 장치가 아니라, <strong style={em}>정체성이 고유한 기여로 전환될 여건</strong>을 공동체가 보장하는 약속이다. 대런 아세모글루(MIT 교수·2024 노벨경제학상)는 <em style={{ fontStyle: "normal", color: C.muted, fontWeight: 600 }}>『권력과 진보』(2023)에서 기술 진보의 향방은 정해진 운명이 아니라 권력과 제도의 선택이 결정한다고 본다.</em>
          </p>
        </div>
