...
const limitRows = [
  ...
  {
    title: "한국의 위치",
    limit: "한국은 미국식 빅테크 패권도, 중국식 국가감시 패권도, 독점기업 중심의 반민주적 기술 엘리트주의도 따를 수 없다. 강대국 사이의 약한 조정자 역할만으로도 세계 질서를 바꿀 수 없다.",
    strategy: "한국은 AI 시민강화 표준을 선점하는 중심 국가가 되어야 한다. 패권경쟁의 비용을 줄이는 안전장치와, 시민의 능력·권리·정체성 실현을 강화하는 사회계약을 함께 제안한다.",
  },
  {
    title: "디지털 시대의 산업 구조",
    limit: "디지털 시대의 산업은 단일 제품이나 제조업 목록으로 움직이지 않는다. AI 인프라, 도시·주거, 공공재, 로봇·드론, 미디어·금융, 교육·건강·국토가 하나의 생활 운영체계로 연결된다.",
