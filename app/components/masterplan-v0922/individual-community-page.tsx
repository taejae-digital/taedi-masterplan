  ...
  const tableData = [
    {
      ...
      tech: "위계를 신성화한 종교 · 기록을 가능케 한 문자 · 관개술",
      expert: "의례·통치의 권위 · 경험의 축적과 전승 · 체화된 생산의 기예",
    ...
    },
    {
      ...
      tech: "관료제·조립라인 · 철도·전신 · 동력기관",
      expert: "생산 시스템을 소유하고 설계 · 분과별 심화 전문성 · 정형화된 반복 노동",
    ...
    },
    {
      age: "디지털",
      ageColor: true,
      tasks: "플랫폼·AI 거버넌스·가치 정렬 설계 · 디지털 시스템 구축·AI 감독 · 디지털 도구·AI 활용·데이터 생산",
      tech: "AI·플랫폼 인프라·정렬 기술 · 소프트웨어·AI 감독·데이터 분석 · 생성 AI·플랫폼·SNS",
      expert: "기술이 추구할 목적과 생태계 규칙 설계 · 기술과 창의를 결합한 가치 생산 · AI와 협업하며 삶의 목적을 설계",
      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            산업화는 인간의 근육을 대체해 조직 관리자를 만들었다. 디지털·AI는 두뇌를 대체·보완하며 새로운 인재상을 요구한다.
          </div>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, marginBottom: 6 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                ...
                <th style={{ padding: "4px 6px", textAlign: "left", width: "20%" }}>핵심 과제</th>
                <th style={{ padding: "4px 6px", textAlign: "left", width: "18%" }}>핵심 기술</th>
                <th style={{ padding: "4px 6px", textAlign: "left", width: "18%" }}>핵심 전문성</th>
                <th style={{ padding: "4px 6px", textAlign: "left", width: "13%" }}>이상적 인재상</th>
                <th style={{ padding: "4px 6px", textAlign: "left" }}>필요한 자유</th>
              </tr>
            </thead>
            <tbody>
              {tableData.map(({ age, ageColor, tasks, tech, expert, ideal, freedom }, i) => (
                <tr key={i} style={{ background: ageColor ? "#f0f4ff" : i % 2 === 0 ? "#fff" : C.bg }}>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, fontWeight: 800, color: C.navy, fontSize: 13, verticalAlign: "top" }}>{age}</td>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, color: "#222", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500, fontSize: 11 }}>{tasks}</td>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, color: "#333", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500, fontSize: 11 }}>{tech}</td>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, color: "#222", lineHeight: 1.5, verticalAlign: "top", fontWeight: 500, fontSize: 11 }}>{expert}</td>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, color: C.navy, fontWeight: 700, lineHeight: 1.45, verticalAlign: "top", fontSize: 11.5 }}>{ideal}</td>
                  <td style={{ padding: "5px 6px", borderBottom: `1px solid #d0d0d0`, color: "#222", lineHeight: 1.45, verticalAlign: "top", fontWeight: 500, fontSize: 11 }}>{freedom}</td>
                </tr>
              ))}
            </tbody>
          </table>
          <div style={{ fontSize: 12, lineHeight: 1.5, color: "#333" }}>
            <strong style={{ color: C.navy }}>시대마다 요구되는 인재상이 달라진다 —</strong> 농업시대는 지혜와 경험을 가진 원로가, 산업시대는 숙련된 노동자와 전문가가, 디지털 시대는 T자형 인간·조율자가 시대를 이끈다. T자형 인간은 여러 분야를 이해·소통·협업하는 가로축 위에 하나의 분야를 깊이 파는 세로축을 가진다. <strong>먼저 풀어야 할 문제를 보면, 그 문제를 푸는 자가 보이고, 거기에 맞는 정체성이 발견된다.</strong>
          </div>
        </div>
