...
export function IndividualCommunityPage() {
  ...
  const eras = [
    ...
    },
    {
      ...
      sub: "분업 · 관리",
      essence: "물리적 한계 극복",
      essenceDetail: "기계가 신체노동 대체 → 노동가치설의 탄생",
      techType: "stack",
    ...
    },
    {
      ...
      sub: "연결 · 자율",
      essence: "인지적 한계 극복",
      essenceDetail: "AI가 인지노동 대체 → 노동가치설의 흔들림",
      techType: "stack",
      ...
      orderDetail: "민주주의·자본주의를 넘는 새 사회계약 — 정체성 실현권, AI 인프라 평등 접근권, 시민 직접 위임 거버넌스권 (진통은 진행 중 — 분배·정체성 갈등)",
      pending: false,
      highlight: true,
    },
  ];
    ...
    <div style={{ pageBreakBefore: "always", minHeight: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 22 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 13.5, lineHeight: 1.55, color: "#222", marginBottom: 10 }}>
            인류는 세 번 자기 한계를 넘었다. <strong>매번 새 기술이 희소했던 자원을 대중화했고, 그 대중화가 새 공동체·새 인재상·새 자유를 끌어냈다.</strong>
          </div>
          {/* 핵심 명제 박스 — P3·P4가 받을 명제 */}
          <div style={{
            display: "flex", alignItems: "stretch",
            background: "#fff",
            border: `1px solid ${C.navy}`,
            borderLeft: `6px solid ${C.accent}`,
            padding: "12px 20px", gap: 16, marginBottom: 12,
          }}>
            <div style={{
            ...
            <div style={{ flex: 1, fontSize: 15.5, fontWeight: 700, lineHeight: 1.55, color: "#222" }}>
              <span style={{ color: "#666" }}>산업시대는 직업이 사람을 빚었다.</span>
              <span style={{ color: C.accent, fontWeight: 800 }}> 디지털시대는 사람의 정체성이 직업을 부른다.</span>
            </div>
          </div>
