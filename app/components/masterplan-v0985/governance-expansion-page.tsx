...
const executionRows = [
  ["세계 경영", "AI 안전·데이터·플랫폼 규칙을 검증할 기술 기반", "싱크탱크·대학·미디어가 연결된 국제 연구 네트워크와 시민 직접 위임 거버넌스", "세계 규범을 제안·협상할 전략 인재", "시민 직접 위임 거버넌스"],
  ["국가 경영", "15대 한반도 미래산업과 공공 AI 인프라", "7대분야 초일류 역량: 싱크탱크·대학·기업·미디어·정부·정당·군대를 정체성 실현 플랫폼으로 혁신", "새 사회계약을 법·예산·권한 구조로 실행할 선출직 인재", "정체성 실현권 / AI 인프라 평등 접근권"],
  ["도시 경영", "시산학 매칭 생태계와 강소도시 네트워크", "일·학습·주거·문화·돌봄이 연결된 생활권 운영체계", "도시별 정체성 실험을 설계·운영할 지역 인재", "정체성 실현권"],
  ["가정 경영", "개인 맞춤 학습·돌봄·건강·관계 지원 AI", "설명·거부·조정권이 작동하는 생활 AI 기준", "판단 주도권을 지키는 교육·돌봄 전문가", "AI 개인화권"],
];
        ...
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
            ...
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                <th style={th}>영역</th>
                <th style={th}>산업 기반</th>
                <th style={th}>제도 역량</th>
                <th style={th}>정치·운영 인재</th>
                <th style={th}>구현 권리</th>
              </tr>
            </thead>
            <tbody>
