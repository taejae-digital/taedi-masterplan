...
const limitRows = [
  {
    ...
    strategy: "한국은 경쟁 중단을 요구하기보다 고위험 AI 검증, 공공 AI 감사 로그, 국제 사고 조사, 군사·생물·사이버 악용 금지선을 공동 운영 규칙으로 제안해 시민을 파괴하지 않는 경쟁의 조건을 만든다.",
  },
  {
    title: "한국의 위치",
    ...
    strategy: "한국은 공급망 안정, 도시 실증, 문화 신뢰, 제도 운영을 묶어 산업 접근과 실증 시장을 제공하되 데이터 주권·AI 검증·시민강화 원칙을 거래 조건으로 붙인다.",
  },
  {
    title: "거대도시의 비효율성",
    ...
    strategy: "강소도시는 학습·건강·돌봄·일자리·행정 데이터를 한 사람의 성장 기록으로 연결하고, 대학·기업·공공조달·시민참여를 붙여 시민강화 성과를 측정 가능한 도시 모델로 만든다.",
  },
  {
    title: "몰개인화",
    ...
    strategy: "가정은 가족 AI 코치와 개인 성장 기록을 통해 학습·건강·돌봄·관계 데이터를 개인이 이해하고 조정할 수 있게 만들고, 플랫폼은 판단 주체가 아니라 서비스 제공자에 머물게 한다.",
  },
];
            ...
            {limitRows.map((row, i) => (
              <div key={row.title} style={{ minHeight: 166, display: "grid", gridTemplateColumns: "108px 1fr", border: `1px solid #d7d0c7`, background: i % 2 ? C.bg : "#fff", boxShadow: "0 1px 0 rgba(0,0,0,0.03)" }}>
                ...
                <div style={{ padding: "9px 12px 9px", display: "grid", gridTemplateColumns: "0.72fr 1fr", gap: 12 }}>
                  ...
                  <div style={{ borderLeft: "5px solid #d9b46f", paddingLeft: 12, fontSize: 11.05, lineHeight: 1.24, color: "#2f2f2f", fontWeight: 540 }}>
