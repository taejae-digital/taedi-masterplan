...
const flow = [
  ...
  },
  {
    ...
    d: "가치의 기준이 오래 일한 시간이 아니라 작고 구체적인 필요를 발견하고 해결하는 능력으로 이동하므로, 정체성 실현권을 중심에 두고 디지털 인프라 접근과 직접 참여가 이를 뒷받침하도록 보장한다.",
    bg: "#f0f5ff",
    c: "#2563eb",
  },
  {
    ...
    <div style={{ height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        ...
        <div>
          ...
          <p style={ps}>
            디지털시대에는 강화된 개인의 자유를 공동체의 지속 가능성과 연결할 새로운 사회계약이 필요하다. 새로운 사회계약은 정체성 실현권을 중심에 두고, 그 아래에서 디지털 인프라 접근권과 직접 거버넌스 참여권이 정체성 실현을 가능하게 하는 권리 구조다.
          </p>
          <p style={ps}>
