...
const limitRows = [
  {
    ...
    strategy: "경쟁 중단을 요구하지 않는다. 안전 사고, 시장 분열, 정당성 위기, 동맹 피로, 국내 불안이라는 패권 비용이 커지는 지점에 공멸선을 긋고, 시민강화 원칙을 공동 검증·인증의 기준으로 제안한다.",
  },
  {
    title: "한국의 위치",
    ...
    strategy: "한국은 AI 시민강화 규칙을 검증하고 확산하는 중심 국가가 되어야 한다. 패권경쟁의 비용을 줄이는 안전장치와, 시민의 능력·권리·정체성 실현을 강화하는 사회계약을 함께 제안한다.",
  },
  {
    title: "디지털 시대의 산업 구조",
    ...
    strategy: "15대 산업을 미래창조형, 세계정상필수, 동북아·한반도 정체성기반 산업으로 묶는다. 산업은 먹거리 목록이 아니라 시민강화 AI 운영 모델을 도시·가정·공공서비스·시장에 실증하는 물적 기반이다.",
  },
  {
    title: "디지털 시대의 거버넌스",
    ...
    strategy: "싱크탱크·대학·기업·미디어·정부·정당·군대의 7대 분야를 초일류화한다. 이 제도들이 산업 실증을 규칙·신뢰·서사·권한으로 바꿀 때 한국의 규칙 형성 권한이 만들어진다.",
  },
];
