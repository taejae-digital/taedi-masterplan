    ...
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", alignItems: "stretch", padding: "7px 32px", borderBottom: `2px solid ${C.navy}`, gap: 0 }}>
        ...
        <div style={{ flex: 1, padding: "7px 12px", background: C.bg, borderRight: `1px solid ${C.line}` }}>
          ...
          <div style={{ fontSize: 11.5, color: "#444", lineHeight: 1.5 }}>기존 질서는 이 변화를 담지 못한다. 정체성 실현권·AI 인프라 평등 접근권·알고리즘 자기결정권이라는 새 권리와, 이를 작동시킬 새 질서가 요구된다.</div>
        </div>
        <div style={{ display: "flex", alignItems: "center", padding: "0 8px", fontSize: 20, color: C.navy, fontWeight: 300 }}>→</div>
      ...
      <div style={{ padding: "4px 32px 0", display: "flex", flexDirection: "column", flex: 1 }}>
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  pol: <>직업=소속 기반 참정 구조 이완, <span style={{ color: C.red, fontWeight: 700 }}>복지국가 위기</span>.</>,
                ...
                },
                {
                  ...
                  pol: <><span style={{ color: C.red, fontWeight: 700 }}>1인 1표 무력화</span>, AI 마이크로타게팅이 공론장 분열. 빅테크가 민주주의 잠식.</>,
        ...
        <div style={{ display: "flex", alignItems: "center", margin: "2px 0 4px", gap: 10 }}>
          ...
          <div style={{ fontSize: 11.5, fontWeight: 700, color: C.navy, background: "#fff", padding: "2px 12px", border: `1px solid ${C.navy}`, borderRadius: 20, whiteSpace: "nowrap" }}>
            ∴ 기존 질서는 이 변화를 담지 못한다 — 새 권리와 새 질서가 필요하다 ▼
          </div>
          <div style={{ flex: 1, height: 1, background: C.line }} />
        </div>
        ...
        {/* 새 사회계약 — 개요 */}
        <div style={{ marginBottom: 6 }}>
          <div style={h3s}>② 새 사회계약 — 기존 질서를 대체할 새 권리와 새 질서</div>
