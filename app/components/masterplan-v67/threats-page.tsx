    ...
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, flex: 1 }}>
        ...
        <div>
          ...
          {/* 4.4 통제 모델 */}
          <div style={h3s}>4.4 위협 통제의 3 모델</div>
          {[
            { n: "①", t: "개발자 입증 책임 (FDA 레짐)", d: "범위 강화 대상. AI 출시 전 안전 입증·사전 승인. 위험을 가장 잘 아는 개발자에게 입증 책임 귀속." },
            { n: "②", t: "과업 한정 한시 위임 (WHO 모델)", d: "영향력 강화 대상. 위기별 권한이 위기 해소 시 자동 해체. 권력의 영구화 차단." },
            { n: "③", t: "역량·기여 기반 분배", d: "생산성 강화 대상. 자본·노동시간이 아닌 문제해결·돌봄·창의·판단 기준. AI 부의 사회 환류." },
          ].map(({ n, t, d }) => (
            <div key={t} style={{ marginBottom: 7, padding: "7px 9px", borderLeft: `3px solid ${C.navy}`, background: C.bg }}>
              <div style={{ fontSize: 12.5, fontWeight: 800, color: C.navy, marginBottom: 3 }}>{n} {t}</div>
