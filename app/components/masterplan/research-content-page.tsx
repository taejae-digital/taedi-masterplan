      ...
      <div style={{ margin: "16px 32px 12px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
          <div style={{ padding: "10px 14px", border: `1px solid ${C.line}`, background: C.bg }}>
            ...
            <div style={{ fontSize: 12, lineHeight: 1.5, color: C.gray }}>
              <p style={{ margin: "0 0 4px" }}><strong>목표:</strong> 『디지털이 초래할 위험성과 그 대책』 2027년 Q3 출간.</p>
              ...
              <p style={{ margin: 0 }}><strong>검증:</strong> 2026년 9~10월 국제 자문단 미팅 피드백 → 2026년 11~12월 집필 착수 → 2027 Q3 출간.</p>
            </div>
          </div>
          <div style={{ padding: "10px 14px", border: `1px solid ${C.line}`, background: C.bg }}>
