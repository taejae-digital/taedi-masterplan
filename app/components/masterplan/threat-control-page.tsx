...
export function ThreatControlPage() {
  ...
  return (
    <div style={{ pageBreakBefore: "always" }}>
      ...
      {/* 통제 프레임워크 요약 */}
      <div style={{ margin: "10px 32px 10px" }}>
      ...
      <div style={{ margin: "0 32px 12px" }}>
        <div style={{ fontSize: 13.5, fontWeight: 700, color: C.navy, marginBottom: 8 }}>디지털 기술의 위험성 — 통제 유형별 위협과 대응</div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            {/* AI 인류 생존 위협 — 최상단 하이라이트 */}
            <tr style={{ background: "#fff5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>진행중</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>Russell(2019) 번복 가능성 원칙</td></tr>
            {/* 금지 rows */}
            <tr style={{ background: "#fef5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>임박</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>화학무기금지협약(CWC) 100% 폐기</td></tr>
            <tr style={{ background: "#fef5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>임박</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>생물무기금지협약(BWC) 실패 교훈</td></tr>
            <tr style={{ background: "#fef5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>진행중</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>핵확산금지조약(NPT) — 강대국 특권 배제</td></tr>
            <tr style={{ background: "#fef5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>진행중</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>바세나르 협정 확장</td></tr>
            {/* 승인 rows */}
            <tr style={{ background: "#fffdf5" }}>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>EU AI Act(2024) 고위험 분류</td></tr>
            <tr style={{ background: "#fffdf5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>진행중</td>
            ...
            <tr style={{ background: "#f0f7f4" }}>
              <td style={{ ...tc, fontWeight: 700 }}>중기</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>뉴딜(1933) + 살트셰바덴(1938)</td></tr>
            <tr style={{ background: "#f0f7f4" }}>
              <td style={{ ...tc, fontWeight: 700 }}>중기</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>Mazzucato(2013) 기업가적 국가</td></tr>
            {/* 구축 row */}
            <tr style={{ background: "#f5f5f5" }}>
              <td style={{ ...tc, fontWeight: 700 }}>장기</td>
              ...
              <td style={{ ...tc, fontSize: 11.5, color: "#333" }}>몬트리올 의정서(1987) 197개국</td></tr>
          </tbody>
        </table>
      </div>
