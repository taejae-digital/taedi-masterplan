    ...
    <div style={{ pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, padding: "0 32px" }}>
        ...
        <div>
          ...
          <p style={ps}>
            디지털이 초래하는 위협은 시간축에 따라 네 층위로 다가온다. <strong>진행 중</strong>인 AI 통제 상실과 감시·조작 체제는 이미 민주주의와 인간의 자율성을 잠식하고 있다. <strong>임박한</strong> AI 군사 비대칭·AI 생물무기·사이버 WMD·핵AI화·자율살상무기는 더 많은 사람이 더 많은 수단으로 죽일 수 있게 만든다. <strong>중기적으로</strong> 대량 실업·정체성 위기와 빅테크 권력 독점은 사회 전체의 구조를 바꾸고, <strong>장기적으로</strong> 거버넌스 공백이 통제 자체를 불가능하게 만든다.
          </p>
          <p style={ps}>
