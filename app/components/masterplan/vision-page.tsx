...
export function VisionPage() {
  ...
  return (
    <div style={{ pageBreakAfter: "always", minHeight: "280mm" }}>
      <Header title="MASTER PLAN v0.1.7" subtitle="1. 비전" />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, padding: "0 32px" }}>
        ...
        <div>
          ...
          <p style={ps}>
            막아야 할 것과 막지 말아야 할 것을 구분해야 한다. 모든 AI를 규제하면 자유의 확장을 저해한다. 통제는 4단계로 나뉜다. <strong>구축</strong>은 통제를 집행할 국제 기구를 세우는 것이다. <strong>금지</strong>는 AI 생물무기, 핵AI화처럼 존재 자체가 위험한 기술을 차단하는 것이다. <strong>승인</strong>은 감시 AI, 자율 에이전트처럼 조건부로 허용하되 사전 검증을 요구하는 것이다. <strong>전환</strong>은 AI 초과이윤 누진세, 돌봄 인정소득처럼 경제 구조를 재편하는 것이다.
          </p>
          ...
          <p style={ps}>
            성공한 통제의 공통점은 세 가지다. 물리적 통제 지점이 있었고(화학무기의 전구물질, 오존의 CFC 대체재), 검증 메커니즘이 작동했으며, 경제적 대안이 존재했다. AI에도 이 조건이 있다. 반도체 공급망(ASML, TSMC, 삼성, NVIDIA)은 물리적 통제 지점이 되고, 컴퓨팅 사용량은 추적 가능하며, AI의 경제적 인센티브는 어느 기술보다 크다.
          </p>
        </div>
