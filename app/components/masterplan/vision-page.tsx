...
export function VisionPage() {
  ...
  return (
    <div style={{ pageBreakAfter: "always", minHeight: "280mm" }}>
      <Header title="MASTER PLAN v0.1.5" subtitle="1. 비전" />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, padding: "0 32px" }}>
        ...
        <div>
          ...
          <p style={ps}>
            성공한 통제의 공통점은 세 가지다. 물리적 통제점이 있었고(화학무기의 전구물질, 오존의 CFC 대체재), 검증 메커니즘이 작동했으며, 경제적 대안이 존재했다. AI에도 이 조건이 있다. 반도체 공급망(ASML, TSMC, 삼성, NVIDIA)은 물리적 통제점이 되고, 컴퓨팅 사용량은 추적 가능하며, AI의 경제적 인센티브는 어느 기술보다 크다.
          </p>
        </div>
