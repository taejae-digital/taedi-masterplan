    ...
    <div style={{ pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, padding: "0 32px" }}>
        ...
        <div>
          ...
          <p style={ps}>
            디지털이 초래하는 위협은 시간접에 따라 세 충류로 다가온다. <strong>지금 당장</strong>, AI 생물무기·사이버 WMD·핵AI화·자율살상무기는 임박한 위협이다 — 더 많은 사람이 더 많은 수단으로 죽일 수 있게 된다. <strong>지금 진행 중</strong>인 감시·조작 체제와 AI 통제 상실은 이미 민주주의와 인간의 자율성을 쉞고 있다. <strong>중장기적으로</strong> 다가오는 대량 실업과 빅테크 권력 독점은 사회 전체의 구조를 바꾼다.
          </p>
          <p style={ps}>
