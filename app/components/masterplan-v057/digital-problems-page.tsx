  ...
  return (
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ padding: "0 32px" }}>
        {/* 1순위 — 비가역·질서 파괴 */}
        <div style={{ padding: "12px 16px", background: "#fee2e2", border: `2px solid ${C.red}`, marginBottom: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
            <div style={{ background: C.red, color: "#fff", fontSize: 11, fontWeight: 800, padding: "3px 10px", letterSpacing: 1 }}>1순위 · 비가역</div>
            <div style={{ fontSize: 15, fontWeight: 800, color: C.red }}>폭력의 민주화 · 대량살상 수단의 개인화</div>
          </div>
          <div style={{ fontSize: 12.5, lineHeight: 1.7, color: "#222" }}>
            생물무기 설계·사이버 공격 인프라·자율 무기는 과거 국가급 자원이 필요했다. AI는 이 진입장벽을 소집단 또는 개인 수준으로 낮춘다.
            AI 기반 생화학무기는 핵무기보다 개발 비용이 낮으면서 피해 규모는 유사하거나 더 클 수 있다. 사이버 WMD는 금융·전력·의료 인프라를 마비시킬 수 있다.
            핵 시스템과 연동된 자율 AI는 오작동이나 해킹 한 번으로 돌이킬 수 없는 결과를 낳는다. <strong>인류 공멸 가능성을 실질적으로 연다.</strong>
          </div>
        </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 6 }}>
              {[
                ...
                <div key={title} style={{ display: "grid", gridTemplateColumns: "64px 1fr", border: `1px solid ${C.line}`, borderLeft: `4px solid ${color}` }}>
                  <div style={{ background: color, color: "#fff", padding: "6px 4px", fontSize: 11, fontWeight: 800, textAlign: "center", letterSpacing: 1 }}>{tag}</div>
