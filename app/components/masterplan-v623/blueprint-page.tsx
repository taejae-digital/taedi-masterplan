        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead>
            <tr style={{ background: C.navy, color: "#fff" }}>
              ...
              <th style={{ padding: "6px 8px", textAlign: "left", fontSize: 11.5, width: "22%" }}>디지털 위협</th>
          ...
          <tbody>
            {[
              ...
              <tr key={i} style={{ background: i % 2 ? C.bg : "#fff" }}>
                ...
                <td style={{ padding: "6px 8px", borderBottom: "1px solid #eee", fontWeight: 700, color: "#222", lineHeight: 1.5 }}>{r.threat}</td>
                <td style={{ padding: "6px 8px", borderBottom: "1px solid #eee", color: "#222", fontSize: 11.5, lineHeight: 1.5 }}>{r.rx}</td>
              </tr>
            ))}
          </tbody>
        </table>
