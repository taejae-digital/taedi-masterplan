        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead>
            <tr style={{ background: C.navy, color: "#fff" }}>
              <th style={{ padding: "6px 8px", textAlign: "left", fontSize: 11.5, width: "12%" }}>전제</th>
              <th style={{ padding: "6px 8px", textAlign: "left", fontSize: 11.5 }}>산업화 시대</th>
              <th style={{ padding: "6px 8px", textAlign: "left", fontSize: 11.5 }}>디지털 시대 — 무너진다</th>
            </tr>
          </thead>
          <tbody>
            {[
              ...
              <tr key={i} style={{ background: i % 2 ? C.bg : "#fff" }}>
                <td style={{ padding: "6px 8px", borderBottom: "1px solid #eee", fontWeight: 700, color: C.navy, lineHeight: 1.5 }}>{premise}</td>
                <td style={{ padding: "6px 8px", borderBottom: "1px solid #eee", color: "#555", lineHeight: 1.5 }}>{old}</td>
                <td style={{ padding: "6px 8px", borderBottom: "1px solid #eee", color: C.red, fontWeight: 600, lineHeight: 1.5 }}>{next}</td>
              </tr>
            ))}
          </tbody>
        </table>
