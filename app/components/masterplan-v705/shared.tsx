...
export function Header({ subtitle, version = "v0.7" }: { subtitle: string; version?: string }) {
  return (
    <div style={{ background: C.navy, color: "#fff", padding: "20px 32px 16px", marginBottom: 0 }}>
      ...
      <div style={{ textAlign: "right", fontSize: 12, opacity: 0.35, marginTop: 3 }}>2026.06</div>
    </div>
  );
}
...
export const ps: React.CSSProperties = { margin: "0 0 10px", fontSize: 12, lineHeight: 1.85, color: "#222", textAlign: "justify" };
export const h3s: React.CSSProperties = { fontSize: 16, fontWeight: 800, color: "#1a2744", margin: "14px 0 7px", paddingBottom: 3, borderBottom: "1px solid #ddd" };
