  ...
  return (
    <div style={{ pageBreakAfter: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        <div>
          <div style={h3s}>① 분업 시대 → 연결 시대 — 디지털 연결이 개인을 강화한다</div>
          <p style={ps}>
          ...
          <div style={h3s}>② 기존 질서의 균열 — 민주주의·자본주의가 응답하지 못한다</div>
          <p style={ps}>
        ...
        <div>
          <div style={h3s}>③ 공동체의 재구성 — 새로운 사회계약이 필요하다</div>
          <p style={ps}>
          ...
          <div style={h3s}>④ 우리의 연구 — 이것을 현실화한다</div>
          <p style={ps}>
