    ...
    <div style={{ pageBreakBefore: "always", height: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "10px 32px 8px", borderBottom: `2px solid ${C.navy}`, marginBottom: 8 }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 800, color: C.navy, lineHeight: 1.35 }}>
          ...
          산업화는 조직 관리자를 만들었지만, 디지털·AI는 <strong>기계와 함께 달리는 혁신가</strong>를 요구한다.
        </div>
      </div>
      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            ...
            산업화는 인간의 근육을 대체해 조직 관리자를 만들었다. 디지털·AI는 두뇌를 대체·보완하며 <strong>기계와 함께 달리는 혁신가</strong>를 요구한다.
          </div>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, marginBottom: 6 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                ...
                <th style={{ padding: "4px 6px", textAlign: "left" }}>인재상 · 필요한 자유</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                },
                {
                  ...
                  ageColor: true,
                  rows: [
                    { level: "리더", task: "플랫폼·AI 거버넌스·가치 정렬 설계", tech: "AI·플랫폼 인프라·정렬 기술", expert: "기술이 추구할 목적과 생태계 규칙 설계", ideal: "기계와 함께 달리는 혁신가 | 플랫폼 종속 없이 미션을 정의할 자유" },
          ...
          <div style={{ fontSize: 12, lineHeight: 1.5, color: "#333" }}>
            <strong style={{ color: C.navy }}>계층이 시대를 만든다 —</strong> 농업시대는 <strong>위계의 권위자</strong>가, 산업시대는 <strong>산업을 개척하는 기업가</strong>가 시대를 정의했다. 디지털 시대는 <strong>기계와 함께 달리는 혁신가</strong>가 그 자리를 맡는다. AI는 도구다 — 그 도구를 어떻게 쓸지 설계하는 자가 다음 시대를 만든다. <strong>먼저 풀어야 할 문제를 보면, 그 문제를 푸는 자가 보이고, 거기에 맞는 정체성이 발견된다.</strong>
          </div>
        </div>
