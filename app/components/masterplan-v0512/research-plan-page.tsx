    ...
    <div style={{ pageBreakBefore: "always", minHeight: "280mm" }}>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 7, marginBottom: 14 }}>
            {[
              { t: "A. 새로운 경제·정치 질서의 이론 정립", d: "자본주의도 공산주의도 아닌 정보화 질서의 이론적 뼈대. 아담 스미스, 카를 마르크스, 장 자크 루소 등을 중심으로 AI 시대에 재해석. 공공 AI 인프라·참여 기반 분배의 논리 구축.", color: C.navy },
              { t: "B. 기술 통제 체계 구상", d: "AI 자율살상무기(LAWS¹²)·AI·사이버 WMD¹³의 국제 레짐. 개발자 입증 책임 레짐과 사전 승인 체계 설계. 미중 대타협의 가능 경로 연구.", color: C.red },
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 7, marginBottom: 12 }}>
            {[
              ...
              { name: "윤준영", scope: "기술·국제 · AI 자율살상무기 + 미중 패권", focus: "LAWS·AI WMD 현황과 국제 레짐 선례 분석, 개발자 입증 책임 체계 설계, 기술 공급망 기반 수출통제 검토, Law Zero¹⁴, ARIA¹⁵ 등 기관과의 네트워킹 모색.", color: C.red },
