...
const limitRows = [
  {
    title: "미·중 패권 경쟁",
    limit: "새 사회계약은 시민에게 AI 인프라 접근권·직접 거버넌스 참여권·정체성 실현권을 보장해야 한다. 그러나 미국과 중국은 AI를 시민 권리보다 군사·금융·제조·플랫폼·데이터·표준·동맹질서의 권력으로 본다. 그래서 접근권은 진영별 플랫폼 의존으로, 데이터 주권은 안보 통제로, 시민 참여는 패권 경쟁의 부담 요인으로 밀린다.",
    strategy: "경쟁 중단을 요구하지 않는다. 안전 사고, 시장 분열, 정당성 위기, 동맹 피로, 국내 불안이라는 패권 비용이 커지는 지점에 공멸선을 긋고, 시민강화 표준을 공동 시장의 기준으로 제안한다.",
  },
  {
    title: "한국의 위치",
    limit: "한국은 세계 규칙을 단독으로 강제할 규모가 부족하다. 그런데 국내에서도 산업·제도·인재가 따로 움직이면 세 권리가 하나의 사회계약으로 묶이지 않는다. 디지털 인프라 접근권은 복지사업, 직접 거버넌스 참여권은 시민 참여 행사, 정체성 실현권은 교육·진로 구호로 흩어진다. 그러면 한국 모델은 세계 표준이 아니라 국내 사업 목록에 머문다.",
    strategy: "한국은 AI 시민강화 표준을 선점하는 중심 국가가 되어야 한다. 패권경쟁의 비용을 줄이는 안전장치와, 시민의 능력·권리·정체성 실현을 강화하는 사회계약을 함께 제안한다.",
  },
  {
    title: "디지털 시대의 산업 구조",
    limit: "세 권리는 생활 속에서 작동해야 한다. 그러나 AI 인프라, 도시·주거, 공공재, 로봇·드론, 미디어·금융, 교육·건강·국토가 분리되어 있으면 권리는 제도 문구로만 남는다. 접근권은 장비 보급에, 참여권은 앱 기능에, 정체성 실현권은 상담 프로그램에 갇히고, 시민이 실제로 더 강해졌다는 증거를 만들 수 없다.",
    strategy: "15대 산업을 미래창조형, 세계정상필수, 동북아·한반도 정체성기반 산업으로 묶는다. 산업은 먹거리 목록이 아니라 시민강화 AI 표준을 도시·가정·공공서비스·시장에 실증하는 물적 기반이다.",
  },
  {
    title: "디지털 시대의 거버넌스",
    limit: "새 사회계약은 예산·법·감사·안보 권한을 가져야 실행된다. 그러나 기존 거버넌스는 부처, 전문가, 선거 주기, 기업 이해관계로 쪼개져 있다. AI 안전은 기술 규제로, 데이터 주권은 개인정보 보호로, 디지털 배당은 복지 재원으로, 시민 직접 참여는 의견 수렴으로 축소된다. 이렇게 분리되면 세 권리는 선언에 그치고 권력 구조를 바꾸지 못한다.",
