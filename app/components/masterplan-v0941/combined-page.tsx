    ...
    <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
      ...
      <thead>
        <tr style={{ background: C.navy, color: "#fff" }}>
          ...
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>② 왜 디지털시대에 안 되는가</th>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>③ 무슨 변화가 있었나</th>
          <th style={{ padding: "5px 8px", textAlign: "left", fontSize: 11.5 }}>④ 그래서 필요한 새 질서</th>
        </tr>
      </thead>
      <tbody>
        {rows.map((r, i) => (
...
const econRows: Row[] = [
  {
    ...
    shift: "측정 혁명 — 디지털 인프라가 돌봄·창작·학습·관계도 추적·기록 가능하게 함",
  ...
  },
  {
    ...
    shift: "가치 발생지 이동 — 노동에서 데이터·AI 모델·플랫폼으로. 자본이 사람 손을 떠남",
  ...
  },
  {
    ...
    shift: "수요 다양화 — 정체성별로 다른 도시·다른 학습·다른 돌봄을 요구",
      ...
      <div style={{ padding: "8px 32px 16px", display: "flex", flexDirection: "column", flex: 1, gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11.5, color: "#222", lineHeight: 1.55, padding: "6px 10px", background: "#f0f4ff", borderLeft: `3px solid ${C.navy}`, marginBottom: 6 }}>
            <strong style={{ color: C.navy }}>산업시대 경제는 시장이 측정한 노동만 가치였다.</strong> 디지털시대는 시장이 측정하지 못했던 가치 활동(돌봄·창작·학습·관계)까지 측정·보상 가능해진다. AI가 시장 노동을 잠식하는 그만큼, 사람의 무게중심은 시장 밖 가치 활동으로 이동한다.
          </div>
        ...
        {/* 3.1 → 3.2 → 3.3 다리: 핵심 명제 */}
        <div style={{
          display: "flex", alignItems: "stretch",
          background: "#fff",
          border: `1px solid ${C.navy}`,
          borderLeft: `6px solid ${C.accent}`,
          padding: "14px 22px", gap: 18,
        }}>
          <div style={{
          ...
          <div style={{ flex: 1, fontSize: 16, fontWeight: 700, lineHeight: 1.55, color: "#222" }}>
            <span style={{ color: "#666" }}>경제는 노동에서 정체성으로, 정치는 독점에서 다층으로.</span>
            <span style={{ color: C.accent, fontWeight: 800 }}> 정체성 실현이 가능한 다층 사회가 디지털시대 새 사회계약의 본질이다.</span>
          </div>
        </div>
