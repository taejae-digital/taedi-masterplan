              ...
              {[
                {
                  ...
                  ageColor: false,
                  rows: [
                    { level: "리더", task: "위계 질서의 정당화", tech: "위계를 신성화한 종교", expert: "의례·통치의 권위", ideal: "덕망 있는 권위자 | 토지 소유와 잉여 처분권" },
                    { level: "프로", task: "세대 간 지식의 전승", tech: "기록을 가능케 한 문자", expert: "경험의 축적과 전승", ideal: "지혜로운 원로 | 기술과 지식을 다음 세대에 전수할 권리" },
                    { level: "아마추어", task: "식량 생산의 안정화", tech: "물을 다스리는 관개술", expert: "체화된 생산의 기예", ideal: "건강하고 부지런한 일꾼 | 노동의 대가를 착취 없이 받을 권리" },
                  ],
                },
                {
                  age: "산업",
                  ageColor: false,
                  rows: [
                    { level: "리더", task: "대규모 조직의 운영·자본 조달", tech: "분업을 제도화한 관료제·조립라인", expert: "생산 시스템을 소유하고 설계", ideal: "산업을 개척하는 기업가 | 자본 조달·시장 진입·계약의 자유" },
                    { level: "프로", task: "공간·시간의 압축·분과 전문화", tech: "거리를 좁힌 철도·전신", expert: "분과별 심화 전문성", ideal: "노련한 분과 전문가 | 직업 선택과 고용 계약 협상의 자유" },
                    { level: "아마추어", task: "인간 근력의 한계 극복", tech: "에너지를 생산하는 동력기관", expert: "정형화된 반복 노동", ideal: "성실한 숙련 노동자 | 단결권·파업권·최저임금 보호" },
                  ],
                },
                {
                  age: "디지털",
                  ageColor: true,
                  rows: [
                    { level: "리더", task: "플랫폼·AI 거버넌스·가치 정렬 설계", tech: "AI·플랫폼 인프라·정렬 기술", expert: "기술이 추구할 목적과 생태계 규칙 설계", ideal: "AI와 함께 설계하는 혁신가 | 플랫폼·빅테크 종속 없이 사업 모델을 설계할 자유" },
                    { level: "프로", task: "디지털 시스템 구축·AI 감독·제도 설계", tech: "소프트웨어·AI 감독·데이터 분석", expert: "기술과 창의를 결합한 가치 생산·비판적 평가", ideal: "개발자·AI 감독자 | 플랫폼 알고리즘에 종속되지 않고 기술 역량을 쌓을 자유" },
                    { level: "아마추어", task: "디지털 도구·AI 활용·데이터 생산", tech: "생성 AI·플랫폼·SNS", expert: "AI와 협업하며 삶의 목적을 설계", ideal: "AI 활용 독립 생산자 | 데이터 주권과 AI 도구 접근권" },
                  ],
                },
                ...
                <tr key={i} style={{ background: ageColor ? "#f0f4ff" : i % 6 < 3 ? "#fff" : C.bg }}>
                  ...
                  <td style={{ padding: "4px 6px", borderBottom: "1px solid #f0f0f0", color: "#222", fontWeight: 500, lineHeight: 1.45, verticalAlign: "top" }}>{ideal.split(" | ")[0]}</td>
                  <td style={{ padding: "4px 6px", borderBottom: "1px solid #f0f0f0", color: "#222", lineHeight: 1.45, verticalAlign: "top", fontWeight: 500 }}>{ideal.split(" | ")[1] || ""}</td>
                </tr>
              ))}
            </tbody>
          </table>
