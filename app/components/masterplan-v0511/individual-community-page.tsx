  ...
  return (
    <div style={{ pageBreakBefore: "always", pageBreakAfter: "always", minHeight: "280mm" }}>
      ...
      <div style={{ padding: "0 32px 14px" }}>
        ...
        <p style={ps}>
          AI 시대의 핵심은 자동화다. 분업의 각 조각을 기계가 점점 더 많이 수행하게 되면서, 그 조각들을 묶어두던 조직의 접착제가 풀린다. 조직은 여전히 존재하지만, 개인이 반드시 그 안에 있어야 할 이유가 줄어든다. 한 명이 AI와 결합해 과거 부서 하나가 하던 일을 해낼 수 있을 때, 개인은 조직에서 떨어져 나와 자신의 역량·관심·기여를 중심으로 삶을 재편할 수 있게 된다. 분업의 시대에 조직이 개인을 조립했다면, 자동화의 시대에 개인은 스스로 조립된다. 이 구조적 전환이 다음에 이어지는 모든 논의 — 역량 확장의 4가지 축, 공동체 재균형, 더 큰 자유 추구 — 의 출발점이다.
        </p>
      </div>
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28 }}>
        ...
        <div>
          ...
          <p style={ps}>
            모든 공동체는 개인의 역량과 권한을 위임받는 구조 위에 세워졌다. 아이가 부모에게 교육을 맡기고, 시민이 국가에 국방을 맡긴 것은 개인이 스스로 그것을 감당할 수 없었기 때문이다. 위임의 정당성은 역량의 비대칭에 기초한다. 역량이 개인에게로 분산되면 공동체 가진 위임의 정당성이 흔들린다. 이제 필요한 것은 위임의 폐지가 아니라 <strong>위임의 재설계</strong>다 — 꼭 필요한 만큼만, 투명하게, 목적이 달성되면 자동으로 환수되는 구조로.
          </p>
