    ...
    <div style={{ pageBreakBefore: "always", minHeight: "281mm", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 32px 10px", borderBottom: `2px solid ${C.navy}`, marginBottom: 12 }}>
        <div style={{ fontSize: 13, color: "#222", lineHeight: 1.6, fontWeight: 600 }}>
          <strong style={{ color: C.navy }}>정체성 → 직업</strong> 인과와 <strong style={{ color: C.navy }}>경제·정치 질서의 재편</strong>, 그리고 <strong style={{ color: C.navy }}>새 사회계약의 세 권리</strong>를 정당화·실증·확산한다. 태재는 이론·공론·솔루션의 세 축을 동시에 끌어올려 실행 가능한 모델로 제시한다.
        </div>
      </div>
      ...
      <div style={{ padding: "0 32px 14px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, flex: 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div>
            <div style={h3s}>4.2 연구 전략 — 국제 협업의 실행</div>
            <div style={{ fontSize: 11.5, color: "#222", lineHeight: 1.5, padding: "5px 9px", background: "#fff8e1", borderLeft: `3px solid ${C.accent}`, marginBottom: 6 }}>
              국제 협력 축(LawZero · EU AI Act / International AI Safety Network · 민주국가 연합)을 실제 협업 관계로 만든다. 영문 IP · 한국 실증 사례 · 거절하기 어려운 자리, 세 가지를 동시에 갖춘다.
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6 }}>
              {[
                ...
                { t: "한국 = 실증 사례", d: "세 권리(정체성 실현권·AI 인프라 평등 접근권·시민 직접 위임 거버넌스권)의 한국 정책 시범. 강소도시·디지털 배당·다층 거버넌스 실증." },
              ].map(({ t, d }) => (
            ...
            {[
              {
                ...
                d: "핵심 명제 — '산업시대는 직업이 사람을 빚었다. 디지털시대는 사람의 정체성이 직업을 부른다' — 의 이론적 정당화. 노동가치설 붕괴를 직시한 동시대 학자(Acemoglu·Mazzucato·Bengio·Zuboff·Perez)와 공동 작업으로 '정체성 실현인'이라는 새 인간상의 정당성 확립.",
              },
              {
                letter: "B",
                t: "새 권리 — 세 권리의 법적·제도적 정립",
              ...
              {
                letter: "D",
                t: "측정·평가 인프라 — 디지털시대 변화의 진단을 데이터로",
