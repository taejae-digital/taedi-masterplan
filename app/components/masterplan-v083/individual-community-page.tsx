              ...
              {[
                ...
                <tr key={i} style={{ background: highlight ? "#f0f4ff" : i % 2 ? C.bg : "#fff" }}>
                  ...
                  <td style={{ padding: "5px 8px", borderBottom: "1px solid #eee", lineHeight: 1.5, verticalAlign: "top" }}>
                    {personal.map((line, j) => <div key={j} style={{ fontSize: 13, color: "#333", fontWeight: j === 2 ? 600 : 400 }}>{line}</div>)}
                  </td>
                  <td style={{ padding: "5px 8px", borderBottom: "1px solid #eee", lineHeight: 1.5, verticalAlign: "top" }}>
                    {community.map((line, j) => <div key={j} style={{ fontSize: 13, color: "#333", fontWeight: j === 2 ? 600 : 400 }}>{line}</div>)}
                  </td>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22, flex: 1, alignItems: "stretch" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: 13, lineHeight: 1.6, color: "#333", marginBottom: 7 }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#666", margin: "0 0 4px", lineHeight: 1.4 }}>계층 재편</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 5 }}>
                {[
                  ...
                  <div key={t} style={{ padding: "5px 7px", borderTop: `2px solid ${C.navy}`, background: C.bg }}>
                    <div style={{ fontSize: 13, fontWeight: 800, color: C.navy, marginBottom: 1 }}>{t}</div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: "#555", marginBottom: 1 }}>{s}</div>
                    <div style={{ fontSize: 13, lineHeight: 1.4, color: "#333" }}>{d}</div>
                    <div style={{ fontSize: 11.5, color: C.accent, fontWeight: 700, marginTop: 2, lineHeight: 1.4 }}>← {a}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#666", margin: "0 0 4px", lineHeight: 1.4 }}>공동체 변화의 3축 — 강화된 개인이 한 국가에 묶이지 않으면서, 공동체의 단위·중심·권한이 동시에 이동한다</div>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#666", margin: "0 0 4px", lineHeight: 1.4 }}>공동체별 재균형 — 가정부터 글로벌까지, 6개 공동체 모두 산업시대 역할에서 디지털시대 역할로 재배치된다</div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} style={{ background: i % 2 ? C.bg : "#fff" }}>
                      ...
                      <td style={{ padding: "3px 7px", borderBottom: "1px solid #eee", color: C.accent, fontWeight: 700, fontSize: 11.5, lineHeight: 1.4 }}>{area}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
