...
export function IndividualCommunityPage() {
  ...
  const historicalEras = [
    ...
    },
    {
      ...
      community: "산업시대 모델 그대로 머물러 있다. 개인의 강화 속도를 따라오지 못하고 있다. (→ 2.3)",
      ...
      <div style={{ padding: "0 32px", flex: 1, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222", marginBottom: 5 }}>
            기술이 달라지면 개인이 바뀌었고, 개인이 바뀌면 그 개인들로 이루어진 공동체도 자연히 따라 바뀌었다.
            <strong style={{ color: C.navy }}> 누가 의도해서가 아니라, 다른 모습으로 살 수밖에 없게 됐기 때문이다.</strong>
            {" "}<span style={{ color: C.red, fontWeight: 700 }}>디지털 시대는 지금 진행 중이며, 그 격차가 풀어야 할 과제다.</span>
          </div>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11.5, marginBottom: 6 }}>
            <thead>
              <tr style={{ background: C.navy, color: "#fff" }}>
                ...
                <th style={{ padding: "5px 8px", textAlign: "left", width: "25%" }}>개인은 어떻게 변했는가</th>
                <th style={{ padding: "5px 8px", textAlign: "left", width: "20%" }}>공동체는 어떻게 변했는가</th>
        ...
        <div>
          ...
          <div style={{ padding: "8px 12px", background: "#fff4f4", borderLeft: `4px solid ${C.red}`, marginTop: 8 }}>
            <div style={{ fontSize: 12.5, lineHeight: 1.5, color: "#222" }}>
              <strong style={{ color: C.red }}>그런데 이번엔 공동체가 자연히 따라오지 못한다.</strong> 개인은 빠르게 강화되는데, 가정·도시·국가·세계는 산업시대 모델 그대로 머물러 있다.
            </div>
          </div>
        </div>
