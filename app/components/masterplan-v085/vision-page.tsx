...
const ps085: React.CSSProperties = { margin: "0 0 10px", fontSize: 13, lineHeight: 1.85, color: "#222", textAlign: "justify" };
const h3s085: React.CSSProperties = { ...h3s, fontSize: 17 };
