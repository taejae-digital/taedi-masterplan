...
const ps085: React.CSSProperties = { margin: "0 0 10px", fontSize: 12.5, lineHeight: 1.85, color: "#222", textAlign: "justify" };
const h3s085: React.CSSProperties = { ...h3s, fontSize: 16.5 };

export function VisionPage() {
  return (
    <div style={{ height: "281mm", display: "flex", flexDirection: "column" }}>
      <Header subtitle="1. 비전" version="v0.8.5" />
      ...
      <div style={{ padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, flex: 1 }}>
        <div>
          <div style={h3s085}>1.1 분업 시대 → 연결 시대 — 디지털 연결이 개인을 강화한다</div>
          <p style={ps085}>
          ...
          <div style={h3s085}>1.2 기존 질서의 균열 — 민주주의·자본주의가 응답하지 못한다</div>
          <p style={ps085}>
        ...
        <div>
          <div style={h3s085}>1.3 공동체의 재구성 — 새로운 사회계약이 필요하다</div>
          <p style={ps085}>
          ...
          <div style={h3s085}>1.4 우리의 연구 — 이것을 현실화한다</div>
          <p style={ps085}>
