...
(async () => {
  ...
  await page.screenshot({ path: '/Users/taejae-agent/.openclaw/workspace-taedi/masterplan-v0.5.2-full.png', fullPage: true });
  ...
  await page.screenshot({ path: '/Users/taejae-agent/.openclaw/workspace-taedi/masterplan-v0.5.2-nano.png', fullPage: true });
