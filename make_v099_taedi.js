...
(async () => {
  ...
  // domcontentloaded 후 충분히 대기
  await page.goto('http://localhost:3000/mp/v0.9.9', { waitUntil: 'domcontentloaded', timeout: 30000 });
  await new Promise(r => setTimeout(r, 12000));

  const outPath = '/Users/taejae-agent/.openclaw/workspace-taedi/masterplan-v0.9.9-final.pdf';
